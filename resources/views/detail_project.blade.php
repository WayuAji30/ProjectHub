        ...
        <div class="relative z-10 w-screen max-w-md mx-auto overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center">
                <div
                    ...
                    <img src="{{asset('assets/img_index/asset/landingPage/modalLengkapiProfil.png')}}" alt="Modal"
                        class="mx-auto mt-9">
                    ...
                    <form action="/profile" class="mx-10">
                        <button
                            class="text-white text-base font-semibold bg-primary-50 rounded-md py-3 mt-10 w-full hover:bg-primary-70 transition-all duration-200 ease-in-out">Lengkapi
                            Sekarang</button>
                    </form>
                    <button
                        class="text-primary-50 my-5 font-semibold hover:underline transition-all duration-200 ease-in-out"
                        id="close">Lakukan Nanti</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="fixed inset-0 flex items-center justify-center z-50">
        ...
        <div class="relative z-10 w-screen max-w-md mx-auto overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4">
                <div
                    class="relative transform overflow-hidden rounded-3xl bg-white drop-shadow-xl transition-all w-[480px]">
                    <div class="flex justify-center mt-9">
                        <div class="bg-primary-50 bg-opacity-10 py-6 px-8 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="54" viewBox="0 0 45 54"
                                fill="none">
                                <path
                                    d="M0.833496 7.54169C0.833548 7.18154 0.905432 6.82501 1.04494 6.49297C1.18446 6.16093 1.38879 5.86005 1.646 5.60794C4.59766 2.71446 8.541 1.05451 12.6734 0.965953C16.8058 0.877398 20.8166 2.3669 23.8895 5.13128L24.8402 6.01961C26.8157 7.7505 29.3528 8.70473 31.9793 8.70473C34.6059 8.70473 37.143 7.7505 39.1185 6.01961L39.7929 5.40482C41.445 4.09669 43.9285 5.14211 44.1533 7.23565L44.1668 7.54169V31.9167C44.1668 32.2769 44.0949 32.6334 43.9554 32.9654C43.8159 33.2975 43.6115 33.5983 43.3543 33.8504C40.4027 36.7439 36.4593 38.4039 32.3269 38.4924C28.1945 38.581 24.1837 37.0915 21.1108 34.3271L20.1602 33.4388C18.2468 31.7623 15.8045 30.8127 13.2613 30.7562C10.718 30.6998 8.23601 31.5401 6.25016 33.13V50.875C6.2494 51.5653 5.98507 52.2293 5.5112 52.7312C5.03732 53.2332 4.38966 53.5352 3.70055 53.5757C3.01144 53.6162 2.33289 53.392 1.80353 52.9489C1.27418 52.5058 0.933985 51.8774 0.852454 51.1919L0.833496 50.875V7.54169Z"
                                    fill="#020179" />
                            </svg>
                        </div>
                    </div>
                    ...
                    <form action="" class="mx-5 mt-4">
                        <div class="inline-flex items-center">
                            <label class="relative flex items-center p-2 rounded-full cursor-pointer" htmlFor="html">
                                <input name="type" type="radio" required
                                    class="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-full border border-light-90 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-primary-50 checked:before:bg-primary-50 hover:before:opacity-10"
                                    id="melanggar" />
                                <span
                                    class="absolute transition-opacity opacity-0 pointer-events-none top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 peer-checked:opacity-100">
                        ...
                        <div class="flex items-center justify-around mt-5 mb-8">
                            <button form="none"
                                class="font-semibold text-light-70 border-2 border-light-70 py-3 rounded-lg lg:w-44 w-36 hover:text-primary-50 hover:border-primary-50 transition-all duration-200 ease-linear">Batal</button>
                            <button
                                class="font-semibold text-white border-2 border-primary-50 bg-primary-50 py-3 rounded-lg lg:w-44 w-36 hover:bg-primary-70 transition-all duration-200 ease-linear">Kirim</button>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="border-t-2 border-light-30 mt-5 hidden sm:block"></div>

<main class="lg:mt-44 md:mt-28 mt-7 lg:px-24 md:px-12 px-6 container mx-auto">
    <nav aria-label="breadcrumb" class="w-max">
        <ol class="flex flex-wrap items-center w-full">
            <li
                class="flex items-center text-light-90 sm:text-xs font-medium leading-normal transition-colors duration-300 cursor-pointer">
                <a href="/index" class="opacity-60 hover:opacity-100">Beranda</a><span
                    class="mx-2 antialiased font-semibold leading-normal pointer-events-none select-none">/</span>
            </li>
            <li
                class="flex items-center text-light-90 sm:text-xs font-medium antialiased leading-normal transition-colors duration-300 cursor-pointer">
                <a href="" class="opacity-60 hover:opacity-100">Detail Projek</a><span
                    class="mx-2 antialiased font-semibold leading-normal pointer-events-none select-none">/</span>
            </li>
        </ol>
    </nav>
...
<section>
    <div class="container mx-auto lg:px-24 md:px-12 px-6 mt-10 sm:mt-4">
                ...
                <div class="bg-[#f3f3f3] bg-opacity-70 rounded-3xl lg:w-[550px] md:w-80 w-full lg:px-11 px-5">
                    <div class="flex items-center justify-between mt-9">
                        ...
                        <div>
                            ...
                            <div
                                class="bg-[#00A410] bg-opacity-10 lg:rounded-xl rounded-md py-3 lg:pl-7 md:pl-2 pl-4 md:w-32 sm:w-36 lg:pr-[100px] mt-5">
                                <p
                                    class="flex items-center font-semibold gap-2 md:gap-1 text-[#004A03] lg:text-[14px] text-xs">
                            ...
                            <div
                                class="bg-[#FFC807] bg-opacity-10 lg:rounded-xl rounded-md py-3 lg:px-7 md:pl-2 pl-4 md:w-32 sm:w-36 mt-5 hidden">
                                <p
                                    class="flex items-center font-semibold gap-2 md:gap-1 text-[#CD9A00] lg:text-[14px] text-xs">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8"
                                        fill="none">
                            ...
                            <div
                                class="bg-[#454545] bg-opacity-10 lg:rounded-xl rounded-md py-3 lg:pl-7 md:pl-2 pl-4 md:w-32 sm:w-36 lg:pr-[100px] mt-5 hidden">
                                <p
                                    class="flex items-center font-semibold gap-2 md:gap-1 text-dark-30 lg:text-[14px] text-xs">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8"
                                        fill="none">
                    ...
                    <div class="flex items-center justify-between mt-5">
                        <div>
                            <p
                                class="flex items-center gap-1 text-primary-50 lg:text-base md:text-xs text-[13px] font-medium">
                        ...
                        <div>
                            <p
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"
                                    fill="none">
                                    <path
                                        d="M6.33301 14.25L9.49967 11.8354L12.6663 14.25L11.4788 10.3312L14.6455 8.07498H10.7663L9.49967 3.95831L8.23301 8.07498H4.35384L7.52051 10.3312L6.33301 14.25ZM9.49967 17.4166C8.40454 17.4166 7.37537 17.2087 6.41217 16.7928C5.44898 16.3769 4.61113 15.813 3.89863 15.101C3.18613 14.3885 2.6222 13.5507 2.20684 12.5875C1.79148 11.6243 1.58354 10.5951 1.58301 9.49998C1.58301 8.40484 1.79095 7.37567 2.20684 6.41248C2.62273 5.44929 3.18666 4.61144 3.89863 3.89894C4.61113 3.18644 5.44898 2.62251 6.41217 2.20715C7.37537 1.79179 8.40454 1.58384 9.49967 1.58331C10.5948 1.58331 11.624 1.79126 12.5872 2.20715C13.5504 2.62304 14.3882 3.18697 15.1007 3.89894C15.8132 4.61144 16.3774 5.44929 16.7933 6.41248C17.2092 7.37567 17.4169 8.40484 17.4163 9.49998C17.4163 10.5951 17.2084 11.6243 16.7925 12.5875C16.3766 13.5507 15.8127 14.3885 15.1007 15.101C14.3882 15.8135 13.5504 16.3777 12.5872 16.7936C11.624 17.2095 10.5948 17.4172 9.49967 17.4166Z"
                                        fill="#020179" />
                                </svg>Kesulitan
                            </p>
                    ...
                    <form action="">
                        <button
                            class="bg-primary-50 text-white py-3 rounded-lg w-full font-semibold lg:my-12 my-6 hover:bg-primary-30 hover:shadow-xl transition-all duration-200 ease-in-out">Daftar
                            Project</button>
                    </form>
                </div>
            </div>
...
<section>
    <div class="container mx-auto mt-14 lg:px-24 md:px-12 px-6">
        <div>
            <div class="flex sm:flex-col sm:gap-3 items-center justify-between lg:mt-12 mt-8">
                <a href="" class="sm:w-full hover:shadow-xl transition-all duration-200 ease-in-out">
                    <div
                        class="flex items-center lg:gap-3 md:gap-2 gap-6 border-2 rounded-lg sm:rounded-2xl bg-white border-light-90 lg:px-9 md:px-3 px-5 sm:w-full py-4">
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-light-90 lg:text-[14px] md:text-[11px] text-xs">Pelajarin cara pakai <br
                ...
                <a href="" class="sm:w-full hover:shadow-xl transition-all duration-200 ease-in-out">
                    <div
                        class="flex items-center gap-3 md:gap-2 border-2 rounded-lg sm:rounded-2xl bg-white border-light-90 lg:pl-8 md:px-3 pl-5 lg:pr-14 sm:w-full py-4">
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-light-90 lg:text-[14px] md:text-[11px] text-xs">Cari tau aturan pakai <br
                                    class="md:block hidden">
                                ProjectHub</p>
                        </div>
                    </div>
                ...
                <a href="" class="sm:w-full hover:shadow-xl transition-all duration-200 ease-in-out">
                    <div
                        class="flex items-center lg:gap-3 md:gap-2 gap-4 border-2 rounded-lg sm:rounded-2xl bg-white border-light-90 lg:pr-24 lg:pl-8 md:px-4 md:pr-6 px-5 sm:w-full md:py-6 py-4">
                        <div>
...
<section>
    <div class="container mx-auto">
        <div class="lg:px-24 md:px-12 px-6 mt-16 sm:mt-10">
            <div class="grid grid-cols-12">
                <div class="lg:col-span-6 col-span-12">
                    <h3 class="text-primary-50 font-semibold lg:text-2xl md:text-xl text-base">Para Pelamar Lainnya</h3>
                    <p class="text-light-70 lg:text-base text-[14px] mt-2 sm:hidden block">Berikut adalah para pelamar
                        lainnya yang juga
                        <br> melamar
                        ke projek ini
                    </p>
                    <div class="lg:mt-10 mt-8">
                        <div class="flex items-center lg:gap-7 md:gap-5 gap-3">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile"
                                class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile"
                                class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile"
                                class="border-2 border-primary-50 rounded-full sm:w-10">
                            ...
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile"
                                class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile"
                                class="border-2 border-primary-50 rounded-full sm:w-10 block sm:hidden">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile"
                                class="border-2 border-primary-50 rounded-full sm:w-10 block sm:hidden">
                        </div>
                        <div class="flex items-center lg:gap-7 md:gap-5 gap-3 lg:mt-8 md:mt-5 mt-3">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile"
                                class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile"
                                class="border-2 border-primary-50 rounded-full sm:w-10">
                        ...
                        <p class="font-semibold text-base text-primary-50 mt-14 sm:mt-7 sm:text-xs">Dan
                            <span>100</span>+
                            pelamar lainnya
                        </p>
                    </div>
            ...
            <div class="border-t-2 border-light-30 mt-14 sm:mt-10"></div>
        </div>
    </div>
</section>
...
<section>
    <div class="container mx-auto">
        <div class="lg:px-24 md:px-12 sm:pl-6 lg:mt-16 md:mt-14 mt-7">
            <div>
                <h4 class="font-semibold lg:text-2xl text-xl text-primary-50">Lihat Juga Projek Lainnya</h4>
                <p class="text-light-70 lg:text-base text-[14px] mt-2 sm:hidden block">Daftarkan juga dirimu ke projek
                    projek lainnya
                    <br> yang tersedia di ProjectHub
                </p>
            </div>
            <div class="md:whitespace-nowrap md:overflow-x-auto sm:whitespace-nowrap sm:overflow-x-auto">
                <div class="flex items-center justify-between mt-10 md:gap-5 sm:gap-5 sm:mb-1 md:mb-1">
                    <a href="">
                        <div class="card bg-white shadow-lg md:shadow-2xl rounded-xl">
                            <div class="flex">
                                <div class="bg-primary-50 w-5 sm:w-3 rounded-l-xl"></div>
                                <div class="pl-5 sm:pl-3 pr-10 sm:pr-7 py-5 sm:py-3">
                                    <p class="font-medium text-[13px] text-primary-50">Desain Grafis</p>
                                    <h5 class="text-dark-70 text-xl sm:text-[14px] mt-2 sm:leading-5">Butuh Jasa UI/UX
                                        Desainer <br> Untuk Website
                                        Sekolah
                                    </h5>
                                    <h6 class="text-light-70 sm:text-xs mt-2">Saya memililki sebuah website jual beli
                                        pulsa, <br> dan
                                        saya
                                        ingin membuat versi aplikasi...</h6>
                                    <p class="font-medium text-xl sm:text-[14px] text-primary-50 sm:mt-2 mt-4">
                                        Rp<span>350.000</span></p>
                                </div>
                            </div>
                        </div>
                    </a>
