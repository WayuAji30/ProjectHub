...
<main class="lg:mt-44 md:mt-28 mt-7 lg:px-24 md:px-12 px-6 container mx-auto">
    <nav aria-label="breadcrumb" class="w-max">
        <ol class="flex flex-wrap items-center w-full">
            <li class="flex items-center text-light-90 sm:text-xs font-medium leading-normal transition-colors duration-300 cursor-pointer">
                <a href="/index" class="opacity-60 hover:opacity-100">Beranda</a><span class="mx-2 antialiased font-semibold leading-normal pointer-events-none select-none">/</span>
            </li>
            <li class="flex items-center text-light-90 sm:text-xs font-medium antialiased leading-normal transition-colors duration-300 cursor-pointer">
                <a href="" class="opacity-60 hover:opacity-100">Detail Projek</a><span class="mx-2 antialiased font-semibold leading-normal pointer-events-none select-none">/</span>
            </li>
        </ol>
    </nav>
</main>
                ...
                <div class="lg:col-span-6 col-span-12">
                    ...
                    <div class="lg:mt-10 mt-8">
                        <div class="flex items-center lg:gap-7 md:gap-5 gap-3">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile" class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile" class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile" class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile" class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile" class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile" class="border-2 border-primary-50 rounded-full sm:w-10">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile" class="border-2 border-primary-50 rounded-full sm:w-10 block sm:hidden">
                            <img src="{{asset('assets/img_index/asset/index/profile.png')}}" alt="profile" class="border-2 border-primary-50 rounded-full sm:w-10 block sm:hidden">
                        </div>
