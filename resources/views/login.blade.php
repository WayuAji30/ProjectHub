...
<div class="lg:col-span-6 col-span-12">
    <div class="lg:ml-20 lg:mt-20 md:mt-20 mt-7">
        <a href="/index">
            <img src="{{asset('assets/img_index/asset/loginandregister/logomobile.svg')}}" alt="" class="lg:hidden block md:mx-auto sm:ml-5 sm:w-[180px]"></a>
        ...
        <form action="" class="lg:ml-0 ml-32 sm:mx-6">
            <button type="submit" class="button-submit flex justify-center items-center gap-3 text-white bg-dark-70 py-3 w-[500px] sm:w-full mt-7 mb-14 text-[18px] rounded-lg font-semibold hover:bg-primary-90 transition-all duration-200 ease-linear">
