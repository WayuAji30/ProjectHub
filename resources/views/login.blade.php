...
<div class="lg:col-span-6 col-span-12">
    <div class="lg:ml-20 lg:mt-28 md:mt-20 mt-7">
        ...
        <p class="text-light-90 mt-2 text-start md:text-center sm:ml-6">Belum Punya Akun? <a href=""
                class="text-primary-50 font-semibold hover:text-primary-70">Daftar</a>
            Dulu Dong</p>
        <form action="" class="lg:mt-14 mt-10 lg:ml-0 md:ml-32 mx-6">
            ...
            <p class="text-end lg:mr-40 md:mr-32 mt-4 text-primary-50 hover:text-primary-70">
