...
<div class="lg:mt-[155px] md:mt-[75px] mt-0">
    <div class="relative">
        ...
        <img src="{{asset('assets/img_index/asset/profile/bg-profilemd.svg')}}" alt=""
            class="w-full lg:hidden block sm:hidden">
    ...
    <div class="">
        <div class="container mx-auto">
            <div class="grid grid-cols-12 relative lg:-mt-20 md:-mt-28 -mt-20">
                <div class="lg:col-span-5 col-span-12 md:mx-16 sm:mx-6">
                    <div class="flex lg:justify-end justify-center">
                        <div
                            class="bg-white rounded-xl lg:shadow-lg shadow-none lg:w-[425px] w-full md:border-2 md:border-light-50 sm:border-2 sm:border-light-50">
                            <div class="relative mt-12">
                                ...
                                <label for="upload-profile"
                                    class="absolute bottom-0 lg:right-[150px] md:right-64 right-[100px] bg-white p-1 rounded-full cursor-pointer">
                                    <div
            ...
            <div class="lg:col-span-7 col-span-12 lg:ml-6 ml-0 md:mx-16 sm:mx-0 md:mt-20 sm:mt-10">
                <div>
                    <div
                        class="bg-white rounded-xl lg:shadow-lg shadow-none lg:w-[650px] w-full md:border-2 md:border-light-50">
                        <div class="mx-10 sm:mx-4">
                            <div class="flex items-center justify-between">
                                <button
                                    class="btn-umum font-semibold text-base text-light-70 pb-3 pt-6 border-b-4 border-primary-50 px-5 sm:px-2">Umum</button>
                                <button
                                    class="btn-dokumen font-semibold text-light-70 border-b-4 pb-3 pt-6 px-5 sm:px-2">Dokumen</button>
                                <button
                                    class="btn-rating font-semibold text-light-70 border-b-4 pb-3 pt-6 px-5 sm:px-2"><span
                                        class="sm:hidden block">Rating
                                        &
                                        Ulasan</span> <span class="sm:block hidden">Ulasan</span></button>
                                <button
                                    class="btn-riwayat font-semibold text-light-70 border-b-4 pb-3 pt-6 px-5 sm:px-2">Riwayat</button>
                            </div>
                        </div>
                        <div class="border-t-2 border-light-30 -mt-[2px]"></div>
                        <div class="umum">
                            <div
                                class="mx-10 mt-10 pb-12 sm:mx-6 sm:border-2 sm:border-light-50 sm:rounded-2xl sm:p-5 sm:pb-10">
                        ...
                        <div class="dokumen hidden">
                            <div>
                                <div
                                    class="mx-10 mt-10 sm:mt-7 pb-20 sm:pb-14 sm:mx-6 sm:border-2 sm:border-light-50 sm:rounded-2xl sm:px-4">
                                    <div class="cvDownload">
                                        <p class="text-dark-70 font-semibold text-base mt-10">CV (Curriculum Vitae)
                                        </p>
                                        <div class="mt-5 sm:mt-3">
                                            <div
                                                class="flex items-center justify-between border-2 border-light-70 rounded-xl sm:rounded-md py-3 sm:py-2 px-4 sm:px-2 mt-2">
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <button class="btn-cv group"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="mt-5 sm:mt-3">
                                            <div
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div class="border-[1px] border-[#D9D9D9] h-8"></div>
                                                    <button class="btn-porto group"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none">
                                                            <g opacity="0.8">
                                                                <path class="group-hover:fill-primary-50"
                                    ...
                                    <div class="riwayat-kosong sm:mt-10" hidden>
                                        <img src="{{asset('assets/img_index/asset/stalker/dokumen-kosong.svg')}}" alt=""
                                            class="mx-auto sm:w-36">
                        ...
                        <div class="rating hidden">
                            <div
                                class="mx-10 sm:mx-6 mt-8 pb-14 sm:border-2 sm:border-light-50 sm:rounded-2xl px-5 py-8">
                                <div class="rating-used">
                                    <div class="border-2 border-light-70 rounded-lg py-10 sm:py-5">
                                        <div
                                            class="flex items-center justify-center sm:justify-between sm:mx-5 gap-16 sm:gap-0">
                                            <div class="text-center">
                                                <p
                                                    class="text-[80px] sm:text-6xl text-dark-70 font-bold leading-[90px]">
                                                    4.5
                                                </p>
                                                <div class="flex items-center gap-2 sm:gap-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="20"
                                            ...
                                            <div>
                                                <div class="flex items-center gap-3 sm:gap-1">
                                                    <p
                                                        class="flex items-center gap-1 text-base sm:text-sm font-semibold text-light-70">
                                                    ...
                                                    <progress class="progress bg-light-30 w-56 sm:w-28" value="90"
                                                        max="100"></progress>
                                                </div>
                                                <div class="flex items-center gap-3 sm:gap-1 mt-1">
                                                    ...
                                                    <progress class="progress bg-light-30 w-56 sm:w-28" value="70"
                                                        max="100"></progress>
                                                </div>
                                                <div class="flex items-center gap-3 sm:gap-1 mt-1">
                                                    <p
                                                    ...
                                                    <progress class="progress bg-light-30 w-56 sm:w-28" value="50"
                                                        max="100"></progress>
                                                </div>
                                                <div class="flex items-center gap-3 sm:gap-1 mt-1">
                                                    <p
                                                    ...
                                                    <progress class="progress bg-light-30 w-56 sm:w-28" value="30"
                                                        max="100"></progress>
                                                </div>
                                                <div class="flex items-center gap-4 sm:gap-2 mt-1">
                                                    ...
                                                    <progress class="progress bg-light-30 w-56 sm:w-28" value="10"
                                                        max="100"></progress>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="rating-kosong" hidden>
                                    <img src="{{asset('assets/img_index/asset/stalker/rating-kosong.svg')}}" alt=""
                                        class="mx-auto sm:w-36">
                        ...
                        <div class="riwayat hidden">
                            <div
                                class="mx-10 sm:mx-6 mt-10 pb-14 sm:border-2 sm:border-light-50 sm:rounded-2xl sm:px-3 sm:py-6">
                                <div>
                                    <div class="border-2 border-light-70 rounded-2xl p-7 sm:p-3">
                                            ...
                                            <div class="sm:hidden block">
                                                <div
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="7" height="7"
                                                        ...
                                                        <circle opacity="0.7" cx="3.5" cy="3.5" r="3.5"
                                                            fill="#004A03" />
                                                    </svg>
                                        ...
                                        <div class="flex gap-10 sm:gap-5 mt-7">
                                            ...
                                            <div class="flex gap-2">
                                                ...
                                                <div>
                                                    <p class="text-xs text-light-70"><span
                                                            class="sm:hidden">Tanggal</span> Selesai</p>
                                        ...
                                        <div class="flex gap-11 sm:gap-5 mt-3">
                                            <div class="flex gap-2">
                                                ...
                                                <div>
                                                    <p class="text-xs text-light-70"><span
                                                            class="sm:hidden">Project</span> Owner</p>
                                        ...
                                        <div class="sm:block hidden mt-5 mb-3">
                                            <div
                                                class="bg-[#DDEEDF] flex items-center gap-2 py-2 w-28 rounded-badge justify-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="7" height="7"
                                                    viewBox="0 0 7 7" fill="none">
                                    ...
                                    <div class="border-2 border-light-70 rounded-2xl p-7 sm:p-3 mt-10 sm:mt-6">
                                        ...
                                        <div class="sm:block hidden mt-5 mb-3">
                                            <div
                                                class="bg-[#E6E6E6] flex items-center gap-2 w-28 py-2 rounded-badge justify-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="7" height="7"
                                                    viewBox="0 0 7 7" fill="none">
                                ...
                                <div class="riwayat-kosong sm:pb-5" hidden>
                                    <img src="{{asset('assets/img_index/asset/stalker/riwayat-kosong.svg')}}" alt=""
                                        class="mx-auto sm:w-36">
                                    <p class="text-base text-light-70 text-center sm:text-sm mt-5">Pengguna Ini Belum
                                        Memiliki <br class="sm:block hidden">
                                        Penilaian
