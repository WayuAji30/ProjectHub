            ...
            <div class="lg:col-span-7 col-span-12 lg:ml-6 ml-0 md:mx-16 sm:mx-0 md:mt-20 sm:mt-10">
                <div>
                    <div class="bg-white rounded-xl lg:shadow-lg shadow-none lg:w-[650px] w-full md:border-2 md:border-light-50">
                        ...
                        <div class="umum">
                            <div class="mx-10 mt-10 pb-12 sm:mx-6 sm:border-2 sm:border-light-50 sm:rounded-2xl sm:p-5 sm:pb-10">
                                <h1 class="text-dark-70 font-medium text-lg">Tentang Saya</h1>
                                <p class="text-dark-10 text-base leading-5 mt-5">Saya adalah orang yang kreatif dan
                                    terbiasa membuat konten seperti artikel, video, atau gambar untuk media sosial.
                                    Selama satu tahun bekerja saya berperan untuk meningkatkan traffic website sebesar
                                    30%. Kreativitas yang saya miliki juga berperan penting dalam meningkatkan
                                    keterampilan leadership sehingga saya bisa mencari solusi saat ada kendala. Saya
                                    adalah orang yang kreatif dan terbiasa membuat konten seperti artikel, video, atau
                                    gambar untuk media sosial. Selama satu tahun bekerja saya berperan untuk
                                    meningkatkan traffic website sebesar 30%. Kreativitas yang saya miliki juga berperan
                                    penting dalam meningkatkan keterampilan leadership sehingga saya bisa mencari solusi
                                    saat ada kendala.</p>
                            </div>
                        </div>
                        <div class="dokumen hidden">
                            <div>
                                <div class="mx-10 mt-10 sm:mt-7 pb-20 sm:pb-14 sm:mx-6 sm:border-2 sm:border-light-50 sm:rounded-2xl sm:px-4">
                                    <div class="cvDownload">
                                        <p class="text-dark-70 font-semibold text-base mt-10">CV (Curriculum Vitae)
                                        </p>
                                        <div class="mt-5 sm:mt-3">
                                            <div class="flex items-center justify-between border-2 border-light-70 rounded-xl sm:rounded-md py-3 sm:py-2 px-4 sm:px-2 mt-2">
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <button class="btn-cv group"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                            <g opacity="0.8">
                                                                <path class="group-hover:fill-primary-50" d="M5 20H19V18H5V20ZM19 9H15V3H9V9H5L12 16L19 9Z" fill="#B3B3B3" />
                                                            </g>
                                                        </svg></button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="border-t-2 border-light-30 mt-10 sm:mt-7"></div>
                                    <div class="portoDownload">
                                        <p class="text-dark-70 font-semibold text-base mt-10 sm:mt-5">Portofolio</p>
                                        <div class="mt-5 sm:mt-3">
                                            <div class="flex items-center justify-between border-2 border-light-70 rounded-xl sm:rounded-md py-3 sm:py-2 px-4 sm:px-2 mt-2">
                                                <div class="flex items-center gap-2 sm:gap-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div class="border-[1px] border-[#D9D9D9] h-8"></div>
                                                    <button class="btn-porto group"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                            <g opacity="0.8">
                                                                <path class="group-hover:fill-primary-50" d="M5 20H19V18H5V20ZM19 9H15V3H9V9H5L12 16L19 9Z" fill="#B3B3B3" />
                                                            </g>
                                                        </svg></button>
                                    ...
                                    <div class="riwayat-kosong sm:mt-10" hidden>
                                        <img src="{{asset('assets/img_index/asset/stalker/dokumen-kosong.svg')}}" alt="" class="mx-auto sm:w-36">
                                        <p class="text-base text-light-70 text-center sm:text-sm mt-5">Pengguna Ini
                                            Belum
                                            Mengunggah<br class="sm:block hidden"> Dokumen Apapun. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="rating hidden">
                            <div class="mx-10 sm:mx-6 mt-8 pb-14 sm:border-2 sm:border-light-50 sm:rounded-2xl px-5 py-8">
                                <div class="rating-used">
                                    <div class="border-2 border-light-70 rounded-lg py-10 sm:py-5">
                                        <div class="flex items-center justify-center sm:justify-between sm:mx-5 gap-16 sm:gap-0">
                                            <div class="text-center">
                                                <p class="text-[80px] sm:text-6xl text-dark-70 font-bold leading-[90px]">
                                                    4.5
                                                </p>
                                                <div class="flex items-center gap-2 sm:gap-1">
                                ...
                                <div class="rating-kosong" hidden>
                                    <img src="{{asset('assets/img_index/asset/stalker/rating-kosong.svg')}}" alt="" class="mx-auto sm:w-36">
                                    <p class="text-base text-light-70 text-center sm:text-sm mt-5">Pengguna Ini Belum
                                        Memiliki <br class="sm:block hidden">
                                        Penilaian
                                        Dari
                                        Siapapun.</p>
                                </div>
                            ...
                            <div class="mx-10 sm:mx-6 mt-10 pb-14 sm:border-2 sm:border-light-50 sm:rounded-2xl sm:px-3 sm:py-6">
                                <div class="riwayat-1">
                                    <div class="border-2 border-light-70 rounded-2xl p-7 sm:p-3">
                                        ...
                                        <div class="flex gap-10 sm:gap-5 mt-7">
                                    ...
                                    <div class="border-2 border-light-70 rounded-2xl p-7 sm:p-3 mt-10 sm:mt-6">
                                        ...
                                        <div class="flex gap-11 sm:gap-8 mt-3">
                                            <div class="flex gap-2">
                                                <div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                        <path d="M13.333 4.00016H10.6663V2.66683C10.6663 1.92683 10.073 1.3335 9.33301 1.3335H6.66634C5.92634 1.3335 5.33301 1.92683 5.33301 2.66683V4.00016H2.66634C1.92634 4.00016 1.33967 4.5935 1.33967 5.3335L1.33301 12.6668C1.33301 13.4068 1.92634 14.0002 2.66634 14.0002H13.333C14.073 14.0002 14.6663 13.4068 14.6663 12.6668V5.3335C14.6663 4.5935 14.073 4.00016 13.333 4.00016ZM9.33301 4.00016H6.66634V2.66683H9.33301V4.00016Z" fill="#B3B3B3" />
                                                    </svg></div>
                                ...
                                <div class="riwayat-kosong sm:pb-5" hidden>
                                    <img src="{{asset('assets/img_index/asset/stalker/riwayat-kosong.svg')}}" alt="" class="mx-auto sm:w-36">
                                    <p class="text-base text-light-70 text-center sm:text-sm mt-5">Pengguna Ini Belum
                                        Memiliki <br class="sm:block hidden">
                                        Penilaian
                                        Dari
