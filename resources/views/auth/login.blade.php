...
<div class="lg:col-span-6 col-span-12">
    <div class="lg:ml-20 lg:mt-20 md:mt-20 mt-7">
        <a href="/">
            <img src="{{asset('assets/img_index/asset/loginandregister/logomobile.svg')}}" alt="" class="lg:hidden block md:mx-auto sm:ml-10 sm:w-[180px]"></a>
        <h1 class="lg:text-[35px] text-3xl lg:mt-0 mt-12 font-semibold sm:ml-10 md:text-center sm:text-[27px]">Selamat
            Datang Kembali!
        </h1>
        <h2 class="text-light-90 mt-3 text-start md:text-center sm:ml-10">Belum Punya Akun? <a href="/register" class="text-primary-50 font-semibold hover:text-primary-70">Daftar</a>
            Dulu Dong</p>
        </h2>
        ...
        <form action="/auth_login" method="post" class="lg:mt-14 mt-10 lg:ml-0 md:ml-32 mx-10">
            ...
            <input type="text" name="email" id="email" required class="text-dark-90 py-3 px-5 border-2 border-light-50 rounded-lg w-[500px] sm:w-full mt-4 focus:outline-primary-50">
            ...
            <div class="relative inline-block sm:block">
                <input type="password" name="password" id="password" required class="text-dark-90 py-3 pl-5 pr-12 border-2 border-light-50 rounded-lg w-[500px] sm:w-full mt-4 focus:outline-primary-50">
            ...
            <p class="text-end lg:mx-[150px] md:mr-28 mr-0 mt-4 text-primary-50 hover:text-primary-70" id="lupapassword">
        ...
        <form action="/login/google" class="lg:ml-0 ml-32 sm:mx-10">
            <button type="submit" class="button-submit flex tracking-wide justify-center items-center gap-3 text-white bg-dark-70 py-3 w-[500px] sm:w-full mt-7 mb-14 text-[18px] rounded-lg font-semibold hover:bg-primary-90 transition-all duration-200 ease-linear">
