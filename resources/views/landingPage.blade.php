        ...
        <div class="bg-primary-70 rounded-l-3xl rounded-tr-3xl md:rounded-3xl sm:rounded-3xl">
            <div class="grid grid-cols-12">
                <div class="lg:col-span-6 col-span-12 lg:ml-32 ml-16 sm:ml-8 mt-14 sm:mt-8">
                    ...
                    <form action="">
                        <button class="text-primary-50 text-lg bg-white rounded-md w-64 sm:w-36 sm:mt-8 sm:mb-8 sm:text-xs py-3 font-semibold mt-14 mb-[58px] hover:-translate-y-2 hover:shadow-white hover:shadow-lg transition-all duration-500 ease-in-out">Daftar
                            Sekarang</button>
                    </form>
                </div>
                ...
                <div class="controller flex justify-between items-center">
                    ...
                    <div id="controls" class="md:hidden sm:hidden flex gap-4">
                        <button class="previous">
                            <div class="border-2 border-primary-50 rounded-full p-2 hover:bg-primary-50 transition-all duration-200 ease-in-out">
                ...
                <div class="my-slider lg:block hidden">
                    <div class="slide">
                        <div id="articles" class="flex items-center justify-between md:gap-12 sm:gap-6 mt-12 sm:mt-8 md:px-16 sm:px-6">
                            <a href="">
                                <article class="group">
                                    <img src="{{asset('assets/img_index/asset/landingPage/article1.png')}}" alt="" class="group-hover:brightness-110">
                            ...
                            <a href="">
                                <article class="group">
                                    <img src="{{asset('assets/img_index/asset/landingPage/article2.png')}}" alt="" class="group-hover:brightness-110">
                                    <p id="categories" class="bg-[#002687] bg-opacity-10 text-primary-50 w-fit px-5 py-2 sm:py-1 sm:px-3 rounded-lg sm:rounded text-xs sm:text-[10px] font-semibold mt-4">
                                        Teknologi</p>
                                    <h2 id="title" class="text-lg font-semibold mt-3 sm:text-[12px]">
                                        <p class="sm:leading-5 text-black">iQoo 12 16 hingga XL Axiata <br>
                            ...
                            <a href="">
                                <article class="group">
                                    <img src="{{asset('assets/img_index/asset/landingPage/article3.png')}}" alt="" class="group-hover:brightness-110">
                                    <p id="categories" class="bg-[#002687] bg-opacity-10 text-primary-50 w-fit px-5 py-2 sm:py-1 sm:px-3 rounded-lg sm:rounded text-xs sm:text-[10px] font-semibold mt-4">
                                        Teknologi</p>
                                    <h2 id="title" class="text-lg font-semibold mt-3 sm:text-[12px]">
                                        <p class="sm:leading-5 text-black">iQoo 12 16 hingga XL Axiata <br>
                            ...
                            <a href="">
                                <article class="group">
                                    <img src="{{asset('assets/img_index/asset/landingPage/article4.png')}}" alt="" class="group-hover:brightness-110">
                                    <p id="categories" class="bg-[#002687] bg-opacity-10 text-primary-50 w-fit px-5 py-2 sm:py-1 sm:px-3 rounded-lg sm:rounded text-xs sm:text-[10px] font-semibold mt-4">
                                        Teknologi</p>
                                    <h2 id="title" class="text-lg font-semibold mt-3 sm:text-[12px]">
                                        <p class="sm:leading-5 text-black">iQoo 12 16 hingga XL Axiata <br>
