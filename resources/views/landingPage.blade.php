...
<section>
    <div class="bg-light-50 bg-opacity-20">
        <div class="lg:mx-16 mx-6">
            <div class="flex sm:flex-wrap items-center lg:justify-between justify-start md:px-8 scrollable-container py-14 sm:mx-2 sm:gap-8">
        ...
        <div class="grid grid-cols-12 mt-14 sm:mt-7">
            <div class="col-span-12 lg:block hidden">
                <div class="flex justify-between">
                    <div class="card-role bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-[165px]">
                    ...
                    <div class="card-role bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-[14px] lg:w-80 md:w-[310px] sm:w-[165px]">
                        <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <g opacity="0.7">
        ...
        <div class="bg-primary-70 rounded-l-3xl rounded-tr-3xl md:rounded-3xl sm:rounded-3xl">
            <div class="grid grid-cols-12">
                ...
                <div class="col-span-6 lg:block hidden -mt-24">
                    <div class="flex justify-end">
                        <img src="{{asset('assets/img_index/asset/landingPage/solusi.png')}}" alt="" class="absolute select-none">
                    </div>
                </div>
            </div>
        </div>
