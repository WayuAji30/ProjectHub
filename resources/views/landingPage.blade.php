...
<main id="bidang">
    <div class="mt-20 mx-16 sm:mx-6 sm:mt-10">
        ...
        <div class="grid grid-cols-12 mt-14 sm:mt-7 sm:ml-2">
            <div class="lg:col-span-3 col-span-6 md:ml-1 ">
                <div class="flex justify-start">
                    <div class="bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-40">
            ...
            <div class="lg:col-span-3 col-span-6 md:ml-1 sm:mt-2 md:mt-6">
                <div class="flex lg:justify-center justify-start">
                    <div class="bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-[14px] lg:w-80 md:w-[310px] sm:w-40">
                        <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <g opacity="0.7">
            ...
            <div class="lg:col-span-3 col-span-6 md:ml-1 sm:mt-2 mt-6">
                <div class="flex justify-start">
                    <div class="bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-40">
                        <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
...
<main>
    ...
    <div class="container mx-auto mt-7" id="owner">
        <h1 class="text-center text-4xl sm:text-2xl">Apa <span class="font-semibold">Yang Bisa</span> Kamu <br class="lg:hidden block"> Lakukan Di <span class="font-semibold">ProjectHub.id?</span></h1>
        <div class="grid grid-cols-12 mt-16 sm:mt-5">
            ...
            <div class="lg:col-span-6 col-span-12">
                <div class="lg:block hidden">
                    <swiper-container class="mySwiper" pagination="false" effect="coverflow" grab-cursor="true" centered-slides="true" slides-per-view="auto" coverflow-effect-rotate="0" coverflow-effect-stretch="0" coverflow-effect-depth="300" coverflow-effect-modifier="1" coverflow-effect-slide-shadows="true">
                        <swiper-slide>
    ...
    <div class="lg:my-36 my-20">
        <div class="grid grid-cols-12">
            ...
            <div class="lg:col-span-6 col-span-12 lg:text-start text-center lg:ml-8 md:mt-14 mt-6">
                <h1 class="text-4xl sm:text-[28px]">Capai <span class="font-semibold">Top Worker <br class="sm:block hidden"> Leaderboard <br class="sm:hidden block"></span>
...
<section class="langkah-langkah md:mt-28">
    <div>
        <h1 class="text-4xl text-center sm:text-3xl"><span class="font-medium">Gimana Sih</span> Cara Pakai <br class="lg:hidden block"> <span class="font-medium">ProjectHub.id</span> Buat <br class="sm:block hidden"> <span class="font-medium">Nyari Uang?</span></h1>
    </div>
