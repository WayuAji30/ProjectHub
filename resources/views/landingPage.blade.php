...
<main id="bidang">
    <div class="mt-20 mx-16 sm:mx-6 sm:mt-10">
        <div class="">
            <h1 class="text-4xl sm:text-2xl lg:text-start text-center text-black">Cari <span
                    class="font-semibold">Pekerjaan</span>
                            ...
                            <div class="card" style="--delay:0;">
                                <div class="bg-white w-fit p-6 rounded-xl drop-shadow-lg">
                                    <div class="flex items-center justify-center gap-5">
                                        ...
                                        <div>
                                            <h1 class="text-black text-lg font-semibold">Buat <span
                                                    class="text-primary-50">Projek</span> dan
    ...
    <div class="lg:my-36 my-20">
        <div class="grid grid-cols-12">
            ...
            <div class="lg:col-span-6 col-span-12 lg:text-start text-center lg:ml-8 md:mt-14 mt-6">
                <h1 class="text-4xl sm:text-[28px] text-black">Capai <span class="font-semibold">Top Worker <br
...
<section class="langkah-langkah md:mt-28">
    <div>
        <h1 class="text-4xl text-center sm:text-3xl text-black"><span class="font-medium">Gimana Sih</span> Cara Pakai
            <br class="lg:hidden block"> <span class="font-medium">ProjectHub.id</span> Buat <br
                class="sm:block hidden"> <span class="font-medium">Nyari Uang?</span>
        </h1>
    </div>
...
<section id="comments">
    ...
    <div class="bg-light-50 bg-opacity-25 w-full lg:pb-20 pb-10">
        ...
        <h1 class="text-4xl text-center mt-6 sm:text-xl text-black">Kata <span
                class="font-semibold text-primary-50">Mereka</span>
            Tentang
        ...
        <section id="slider">
            <div class="slider-wrapper">
                <div class="controller flex justify-between items-center">
                    <div>
                        <h1 class="text-4xl sm:text-xl sm:ml-6 md:ml-16 text-black">Baca <span
                                class="font-semibold">Artikel</span>
                            Kami</h1>
                    </div>
                    <div id="controls" class="md:hidden sm:hidden flex gap-4">
                        <button class="previous">
                            <div
                                class="border-2 border-primary-50 rounded-full p-2 hover:bg-primary-50 transition-all duration-200 ease-in-out">
