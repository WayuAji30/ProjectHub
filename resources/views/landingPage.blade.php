    ...
    <div class="md:mt-20 sm:mt-20">
        <div class="lg:bg-hero-landing md:bg-hero-landing-md bg-hero-landing-sm bg-no-repeat w-full">
            <div class="bg-primary-50 bg-opacity-80">
                <div class="grid grid-cols-12 lg:mx-16 md:mx-14 mx-6">
    ...
    <div class="bg-light-50 bg-opacity-20">
        <div class="container mx-auto">
            <div class="lg:mx-16 mx-6">
                <div
                    class="flex sm:flex-wrap items-center lg:justify-between justify-start md:px-8 scrollable-container py-14 sm:mx-2 md:gap-10 sm:gap-8">
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-[16px] text-light-70 mt-3 sm:mt-2 sm:text-[12px] leading-5">Jadi project
                                owner
                                saat kamu
                                butuh <br>
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-[16px] text-light-70 mt-3 sm:mt-2 sm:text-[12px] leading-5">Cari uang
                                tambahan
                                dengan
                                mudah <br>
    ...
    <div class="container mx-auto">
        <div class="mt-20 mx-16 sm:mx-6 sm:mt-10">
            <div class="">
                ...
                <p class="mt-5 text-lg sm:text-[13px] lg:text-start text-center text-light-90 sm:leading-5">Tersedia
                    banyak
                    bidang
                    yang bisa
            ...
            <div class="grid grid-cols-12 mt-14 sm:mt-7">
                <div class="col-span-12 lg:block hidden">
                    <div class="flex justify-between">
                        <div
                            class="card-role bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-[165px]">
                        ...
                        <div
                            class="card-role bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-[14px] lg:w-80 md:w-[310px] sm:w-[165px]">
                            <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <g opacity="0.7">
                                ...
                                <p class="text-primary-50 text-lg font-semibold sm:text-[10px] sm:leading-3">Penulisan &
                                    <br class="hidden sm:block"> Penerjemah
                                </p>
                            </div>
                        </div>
                        <div
                ...
                <div class="col-span-12 lg:block hidden mt-5">
                    <div class="flex justify-between">
                        <div
                            class="card-role bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-[165px]">
                            <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
                ...
                <div class="lg:col-span-3 col-span-6 lg:hidden">
                    <div class="flex justify-start">
                        <div
                            class="bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-[165px]">
                            <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="22" height="22"
                                    viewBox="0 0 22 22" fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="lg:col-span-3 col-span-6 sm:mt-2 md:mt-6 lg:hidden">
                ...
                <div class="lg:col-span-3 col-span-6 sm:mt-2 mt-6 lg:hidden">
                    <div class="flex justify-start">
                        <div
                            class="bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-[165px]">
                            <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
...
<main id="threeSolution">
    <div class="bg-primary-70 w-full mt-24 sm:mt-12 container mx-auto">
...
<section id="leaderboard">
    <div class="lg:my-36 my-20 container mx-auto">
        <div class="grid grid-cols-12">
...
<section class="langkah-langkah md:mt-28 container mx-auto">
    <div>
                ...
                <div class="grid grid-cols-12">
                    <div class="lg:col-span-6 col-span-12 lg:ml-32 ml-16 sm:ml-8 mt-14 sm:mt-8">
                        ...
                        <p class="text-white text-base mt-3 sm:text-xs">Mau rekrut freelancer buat projek kamu? <br
                            ...
                            santai dimanapun?<br class="hidden sm:block"> Gabung <br class="block sm:hidden"> dengan
                            kami
                        ...
                        <form action="/register">
                            <button
                                class="text-primary-50 text-lg bg-white rounded-md w-64 sm:w-36 sm:mt-8 sm:mb-8 sm:text-xs py-3 font-semibold mt-14 mb-[58px] hover:bg-light-30 transition-all duration-200 ease-in-out">Daftar
                                Sekarang</button>
                        </form>
                    </div>
                    <div class="col-span-6 lg:block hidden -mt-24">
                        <div class="flex justify-end">
                            <img src="{{asset('assets/img_index/asset/landingPage/solusi.png')}}" alt=""
