                ...
                <div class="grid grid-cols-12 lg:mx-16 mx-14 sm:mx-6">
                    ...
                    <div class="col-span-6 lg:block hidden">
                        <img src="{{asset('assets/img_index/asset/landingPage/peoplepink.png')}}" alt="peoplePink"
                            class="mx-auto mt-40 select-none">
                    </div>
                </div>
            </div>
        </div>
...
<section>
    <div class="bg-light-50 bg-opacity-20">
        <div class="lg:mx-16 mx-6">
            <div
                class="flex sm:flex-wrap items-center lg:justify-between justify-start md:px-8 scrollable-container py-14 sm:mx-2 gap-20 sm:gap-8">
                <div class="flex items-center gap-6">
                    <div class="bg-[#E6EAF3] p-4 sm:px-5 rounded-full"><svg xmlns="http://www.w3.org/2000/svg"
                            class="sm:w-8" width="42" height="42" viewBox="0 0 42 42" fill="none">
                            <path
                                d="M31.5 14H29.75V10.5C29.75 5.67 25.83 1.75 21 1.75C16.17 1.75 12.25 5.67 12.25 10.5V14H10.5C8.575 14 7 15.575 7 17.5V35C7 36.925 8.575 38.5 10.5 38.5H31.5C33.425 38.5 35 36.925 35 35V17.5C35 15.575 33.425 14 31.5 14ZM21 29.75C19.075 29.75 17.5 28.175 17.5 26.25C17.5 24.325 19.075 22.75 21 22.75C22.925 22.75 24.5 24.325 24.5 26.25C24.5 28.175 22.925 29.75 21 29.75ZM15.75 14V10.5C15.75 7.595 18.095 5.25 21 5.25C23.905 5.25 26.25 7.595 26.25 10.5V14H15.75Z"
                                fill="#020179" />
                        </svg>
                    </div>
                    <div>
                ...
                <div class="flex items-center gap-6">
                    <div class="bg-[#E6EAF3] p-4 sm:py-3 rounded-full"><svg xmlns="http://www.w3.org/2000/svg"
                            class="sm:w-10" width="48" height="48" viewBox="0 0 48 48" fill="none">
                            <path
        ...
        <div class="">
            ...
            <p class="mt-5 text-lg sm:text-[13px] lg:text-start text-center text-light-90 sm:leading-5">Tersedia banyak
                ...
                keahlianmu.<br class="hidden sm:block"> <span class="font-medium">Pemrograman, desain,
                    keuangan,<br class="block sm:hidden"> menulis,</span><br class="hidden sm:block"> dan <span
                    class="font-medium">masih banyak lagi.</span>
            </p>
        </div>
        <div class="grid grid-cols-12 mt-14 sm:mt-7">
            ...
            <div class="lg:col-span-3 col-span-6 sm:mt-2 md:mt-6">
                <div class="flex lg:justify-center justify-start">
                    <div
                        class="bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-[14px] lg:w-80 md:w-[310px] sm:w-[165px]">
                        <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="24" height="24"
                                viewBox="0 0 24 24" fill="none">
                                <g opacity="0.7">
                            ...
                            <p class="text-primary-50 text-lg font-semibold sm:text-[10px] sm:leading-3">Penulisan & <br
                                    class="hidden sm:block"> Penerjemah</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-[165px]">
                        <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="23" height="23"
                                ...
                                <g opacity="0.7">
                                    <path
                                        d="M17.25 13.1428C17.9036 13.1428 18.5304 13.4025 18.9925 13.8646C19.4547 14.3267 19.7143 14.9535 19.7143 15.6071V16.1944C19.7143 19.1327 16.2561 21.3571 11.5 21.3571C6.74394 21.3571 3.28572 19.2485 3.28572 16.1944V15.6071C3.28572 14.9535 3.54535 14.3267 4.00749 13.8646C4.46964 13.4025 5.09644 13.1428 5.75001 13.1428H17.25ZM11.5 1.64282C12.1472 1.64282 12.7881 1.7703 13.3861 2.01799C13.9841 2.26567 14.5274 2.62871 14.985 3.08637C15.4427 3.54403 15.8057 4.08735 16.0534 4.68531C16.3011 5.28327 16.4286 5.92416 16.4286 6.57139C16.4286 7.21862 16.3011 7.85951 16.0534 8.45748C15.8057 9.05544 15.4427 9.59876 14.985 10.0564C14.5274 10.5141 13.9841 10.8771 13.3861 11.1248C12.7881 11.3725 12.1472 11.5 11.5 11.5C10.1929 11.5 8.93927 10.9807 8.01498 10.0564C7.09069 9.13213 6.57144 7.87853 6.57144 6.57139C6.57144 5.26426 7.09069 4.01065 8.01498 3.08637C8.93927 2.16208 10.1929 1.64282 11.5 1.64282Z"
                                        fill="#020179" />
                                </g>
                            </svg>
            ...
            <div class="lg:col-span-3 col-span-6 sm:mt-2 mt-6">
                <div class="flex justify-start">
                    <div class="bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-[165px]">
                        <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="20" height="20"
                                viewBox="0 0 20 20" fill="none">
                                <g opacity="0.7">
                                    <path
                                        d="M6.99 3.08007L18.01 1.08007C18.56 1.00007 19 1.53007 19 2.08007V14.5001C19 16.4401 17.43 18.0001 15.5 18.0001C13.57 18.0001 12 16.4401 12 14.5001C12 12.5701 13.57 11.0001 15.5 11.0001C16.04 11.0001 16.54 11.1401 17 11.3501V5.08007L8 7.08007V16.0001C7.76 17.7001 6.26 19.0001 4.5 19.0001C2.57 19.0001 1 17.4401 1 15.5001C1 13.5701 2.57 12.0001 4.5 12.0001C5.04 12.0001 5.54 12.1401 6 12.3501V4.08007C6 3.53007 6.44 3.17006 6.99 3.08007Z"
                                        fill="#020179" />
                                </g>
                            </svg>
                    ...
                    <div class="bg-[#002687] bg-opacity-10 rounded-lg py-6 sm:py-3 lg:w-80 md:w-[310px] sm:w-[165px]">
                        <div class="flex items-center gap-3 lg:ml-10 md:ml-7 ml-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="23" height="23"
                                ...
                                <g opacity="0.7">
                                    <path
                                        d="M20.125 18.2083V4.79167C20.125 3.7375 19.2625 2.875 18.2083 2.875H4.79167C3.7375 2.875 2.875 3.7375 2.875 4.79167V18.2083C2.875 19.2625 3.7375 20.125 4.79167 20.125H18.2083C19.2625 20.125 20.125 19.2625 20.125 18.2083ZM8.14583 12.9375L10.5417 15.8221L13.8958 11.5L18.2083 17.25H4.79167L8.14583 12.9375Z"
                                        fill="#020179" />
                                </g>
                            </svg>
...
<main>
    <div class="mt-28 sm:mt-12">
        <div class="flex items-center justify-center gap-4">
            <button class="text-light-70 text-lg sm:text-xs transition-all duration-300 ease-in-out"
                id="btnFreelancer">Sebagai
                <span class="font-semibold">Freelancer</span></button>
            <div class="border-[1px] border-light-70 h-5"></div>
            <button class="text-primary-50 text-lg sm:text-xs transition-all duration-300 ease-in-out"
                id="btnOwner">Sebagai <span class="font-semibold">Project
                    Owner</span></button>
        </div>
    </div>
    ...
    <div class="container mx-auto mt-7" id="owner">
        <h1 class="text-center text-4xl sm:text-2xl">Apa <span class="font-semibold">Yang Bisa</span> Kamu <br
                class="lg:hidden block"> Lakukan Di <span class="font-semibold">ProjectHub.id?</span></h1>
        <div class="grid grid-cols-12 mt-16 sm:mt-5">
            <div class="col-span-6 lg:block hidden">
                <img src="{{asset('assets/img_index/asset/landingPage/mainpeople1.png')}}" alt="Project Owner"
                    class="mx-auto">
            </div>
            <div class="lg:col-span-6 col-span-12">
                <div class="lg:block hidden">
                    <swiper-container class="mySwiper" pagination="false" effect="coverflow" grab-cursor="true"
                        centered-slides="true" slides-per-view="auto" coverflow-effect-rotate="0"
                            ...
                            <div class="flex justify-center transition-all duration-300 ease-in-out">
                                <div class="bg-white w-fit p-6 rounded-xl">
                                    <div class="flex items-center justify-center gap-5">
                                        <div class="bg-[#E6EAF3] p-4 sm:px-5 rounded-full"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                viewBox="0 0 30 30" fill="none">
                                                <path
                                                    d="M26.3333 0.833496H3.66667C2.10834 0.833496 0.833336 2.1085 0.833336 3.66683V29.1668L6.5 23.5002H26.3333C27.8917 23.5002 29.1667 22.2252 29.1667 20.6668V3.66683C29.1667 2.1085 27.8917 0.833496 26.3333 0.833496ZM6.5 17.8335V14.3343L16.2467 4.58766C16.53 4.30433 16.9692 4.30433 17.2525 4.58766L19.76 7.09516C20.0433 7.3785 20.0433 7.81766 19.76 8.101L9.99917 17.8335H6.5ZM22.0833 17.8335H12.875L15.7083 15.0002H22.0833C22.8625 15.0002 23.5 15.6377 23.5 16.4168C23.5 17.196 22.8625 17.8335 22.0833 17.8335Z"
                                                    fill="#020179" />
                                            </svg></div>
                                        <div>
                                            <h1 class="text-light-90 text-lg font-semibold">Beri Review dan Rating Ke
                                                Freelancer
                                            </h1>
                                            <p class="text-[12px] text-light-90 mt-3">Kamu bisa memberikan rating dan
                                                review
                                                kepada
                        ...
                        <swiper-slide class="mb-24 sm:mb-14">
                            <div class="flex justify-center transition-all duration-300 ease-in-out">
                                <div class="bg-white w-fit p-10 sm:px-5 sm:py-6 rounded-xl drop-shadow-lg">
                                    <div class="flex items-center justify-center gap-5">
                                        <div class="bg-[#E6EAF3] p-4 sm:py-3 sm:px-4 rounded-full"><svg
                                                xmlns="http://www.w3.org/2000/svg" class="w-6" width="30" height="30"
                                                viewBox="0 0 30 30" fill="none">
                                                <path
                                                    d="M26.3333 0.833496H3.66667C2.10834 0.833496 0.833336 2.1085 0.833336 3.66683V29.1668L6.5 23.5002H26.3333C27.8917 23.5002 29.1667 22.2252 29.1667 20.6668V3.66683C29.1667 2.1085 27.8917 0.833496 26.3333 0.833496ZM6.5 17.8335V14.3343L16.2467 4.58766C16.53 4.30433 16.9692 4.30433 17.2525 4.58766L19.76 7.09516C20.0433 7.3785 20.0433 7.81766 19.76 8.101L9.99917 17.8335H6.5ZM22.0833 17.8335H12.875L15.7083 15.0002H22.0833C22.8625 15.0002 23.5 15.6377 23.5 16.4168C23.5 17.196 22.8625 17.8335 22.0833 17.8335Z"
                                                    fill="#020179" />
        ...
        <div class="grid grid-cols-12">
            <div class="lg:col-span-6 col-span-12 lg:order-1 order-2 lg:ml-32 lg:mt-28 md:-mt-40 md:mb-24 mt-10 mb-12">
                <img src="{{asset('assets/img_index/asset/loginandregister/logo.svg')}}" alt="logoProjectHub"
                    class="md:mx-auto sm:mx-auto sm:w-40">
                <h1 class="text-white text-4xl mt-14 sm:text-2xl sm:mt-7 lg:text-start text-center"><span
                        class="font-semibold">Solusi</span> Buat Si Paling <br class="lg:block hidden">
                ...
                <div class="flex items-start mt-11 gap-3 md:ml-32 sm:text-center sm:justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="sm:hidden block" width="24" height="24"
                        viewBox="0 0 24 24" fill="none">
                        <path
                    ...
                    <div>
                        <h2
                            class="text-xl sm:text-base font-semibold text-white sm:flex sm:items-center sm:justify-center sm:gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sm:block hidden sm:w-4" width="24"
                ...
                <div class="flex items-start mt-8 gap-3 md:ml-32 sm:text-center sm:justify-center">
                    ...
                    <div>
                        ...
                        <p class="text-white text-[16px] sm:text-xs mt-3">Ngga perlu lagi bayar karyawan per bulan,
                            ...
                            saat <br class="sm:hidden block"> kamu butuh aja kalo pakai jasa para <br
                                class="sm:block hidden"> freelancer.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2 col-span-4 lg:order-2 order-1"><img
                    src="{{asset('assets/img_index/asset/landingPage/2people.png')}}" alt="" class="w-full md:h-[70%]">
            </div>
            <div class="lg:col-span-2 col-span-4 lg:order-2 order-1"><img
                    src="{{asset('assets/img_index/asset/landingPage/3people.png')}}" alt="" class="w-full md:h-[70%]">
            </div>
        </div>
    </div>
</main>
...
<section id="leaderboard">
    <div class="lg:my-36 my-20">
        <div class="grid grid-cols-12">
            <div class="lg:col-span-6 col-span-12"><img
                    src="{{asset('assets/img_index/asset/landingPage/leaderboard.svg')}}" alt="leaderboard"
                    class="mx-auto select-none md:w-[70%] sm:w-80"></div>
            <div class="lg:col-span-6 col-span-12 lg:text-start text-center lg:ml-8 md:mt-14 mt-6">
                <h1 class="text-4xl sm:text-[28px]">Capai <span class="font-semibold">Top Worker <br
                            class="sm:block hidden"> Leaderboard <br class="sm:hidden block"></span>
                    Dan<br class="sm:block hidden"> Dapatkan
                    <span class="font-semibold text-primary-50">spesial Badge</span>
                </h1>
                <p class="text-lg text-light-90 mt-5 sm:text-base">Selesaikan projek sebanyak banyaknya agar<br
                        class="sm:block hidden"> nama kamu
                    ...
                    masuk ke
                    sosial
                    media<br class="sm:block hidden"> ProjectHub dengan menjadi top 3 worker <br
                        class="sm:hidden block"> di<br class="sm:block hidden"> leaderboard. Jadilah legenda yang
                ...
                <form action="" class="sm:mx-6">
                    <button
                        class="bg-primary-50 py-3 text-white w-[550px] sm:w-full text-lg font-semibold rounded-lg lg:mt-16 md:mt-14 mt-10 hover:bg-primary-70 transition-all duration-200 ease-in-out">Lihat
                        Leaderboard</button>
                </form>
            </div>
        </div>
...
<section class="langkah-langkah md:mt-28">
    <div>
        <h1 class="text-4xl text-center sm:text-3xl"><span class="font-medium">Gimana Sih</span> Cara Pakai <br
                class="lg:hidden block"> <span class="font-medium">ProjectHub.id</span> Buat <br
                class="sm:block hidden"> <span class="font-medium">Nyari Uang?</span></h1>
    </div>
                        ...
                        <li class="splide__slide">
                            <div class="flex items-center justify-evenly mb-20 sm:mb-14">
                                <div class="quote bg-white rounded-lg p-8 md:px-16 drop-shadow-md">
                                    <p class="sm:leading-4"><q
                                            class="italic text-dark-30 sm:text-[10px] sm:leading-3">Menurut
                                            saya
                                            ini merupakan suatu
                                ...
                                <div class="quote bg-white rounded-lg p-8 drop-shadow-md lg:block hidden">
                                    <p class="sm:leading-4"><q cla class="leading-4"
                                            ss="italic text-dark-30 sm:text-[10px] sm:leading-3">Menurut
            ...
            <div class="grid grid-cols-12">
                <div class="lg:col-span-6 col-span-12 lg:ml-32 ml-16 sm:ml-8 mt-14 sm:mt-8">
                    <h1 class="text-white text-4xl sm:text-xl">
                        <p class="sm:leading-6"><span class="font-semibold">Solusi</span> Buat <span
                                class="font-semibold">Si Paling <br></span>
                            Work Life <span class="font-semibold">Balance.</span></p>
                    </h1>
                    <p class="text-white text-base mt-3 sm:text-xs">Mau rekrut freelancer buat projek kamu? <br
                            class="hidden sm:block"> atau mau
                        cari pekerjaan
                    ...
                    <form action="">
                        <button
                            class="text-primary-50 text-lg bg-white rounded-md w-64 sm:w-36 sm:mt-8 sm:mb-8 sm:text-xs py-3 font-semibold mt-14 mb-[58px] transition-all duration-200 ease-in-out">Daftar
                            Sekarang</button>
                    </form>
                </div>
        ...
        <section id="slider">
            <div class="slider-wrapper">
                <div class="controller flex justify-between items-center">
                    <div>
                        <h1 class="text-4xl sm:text-xl sm:ml-6 md:ml-16">Baca <span class="font-semibold">Artikel</span>
                            Kami</h1>
                    </div>
                ...
                <div class="my-slider lg:block hidden">
                    <div class="slide">
                        <div id="articles"
                            class="flex items-center justify-between md:gap-12 sm:gap-6 mt-12 sm:mt-8 md:px-16 sm:px-6">
                            <a href="">
                                <article>
                                    <img src="{{asset('assets/img_index/asset/landingPage/article1.png')}}" alt="">
                                    <p id="categories"
                                        class="bg-[#002687] bg-opacity-10 text-primary-50 w-fit px-5 py-2 sm:py-1 sm:px-3 rounded-lg sm:rounded text-xs sm:text-[10px] font-semibold mt-4">
                                        Teknologi</p>
                                    ...
                                    <div class="flex items-center text-[13px] mt-5">
