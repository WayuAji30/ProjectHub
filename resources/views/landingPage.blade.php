...
<section>
    <div class="bg-light-50 bg-opacity-20">
        <div class="lg:mx-16 mx-6">
            <div
                class="flex sm:flex-wrap items-center lg:justify-between justify-start md:px-8 scrollable-container py-14 sm:mx-2 sm:gap-8">
            ...
            <div class="grid grid-cols-12">
                <div class="lg:col-span-6 col-span-12 lg:ml-32 ml-16 sm:ml-8 mt-14 sm:mt-8">
                    ...
                    <form action="/register">
                        <button
                            class="text-primary-50 text-lg bg-white rounded-md w-64 sm:w-36 sm:mt-8 sm:mb-8 sm:text-xs py-3 font-semibold mt-14 mb-[58px] hover:-translate-y-2 hover:shadow-white hover:shadow-lg transition-all duration-500 ease-in-out">Daftar
                            Sekarang</button>
                    </form>
                </div>
