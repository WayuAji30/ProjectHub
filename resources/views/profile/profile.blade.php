...
<div class="lg:mt-[155px] md:mt-[75px] mt-0">
    <div class="relative">
        ...
        <img src="{{asset('assets/img_index/asset/profile/bg-profilemd.svg')}}" alt="" class="w-full lg:hidden block sm:hidden">
        <img src="{{asset('assets/img_index/asset/profile/bg-profilesm.svg')}}" alt="" class="w-full hidden sm:block">
    </div>
</div>
...
<main id="profil-me">
    <div class="">
        <div class="container mx-auto">
                        ...
                        <div class="mx-10 mt-10">
                            <div class="border-y-2 border-light-30">
                                <div class="flex items-center justify-between mt-4 mx-1">
                                    <p class="flex items-center gap-2 text-dark-70 text-base font-medium"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <path d="M10.95 15.55L16.6 9.9L15.175 8.475L10.95 12.7L8.85 10.6L7.425 12.025L10.95 15.55ZM12 22C9.68333 21.4167 7.771 20.0873 6.263 18.012C4.755 15.9367 4.00067 13.6327 4 11.1V5L12 2L20 5V11.1C20 13.6333 19.246 15.9377 17.738 18.013C16.23 20.0883 14.3173 21.4173 12 22Z" fill="#020179" />
            ...
            <div class="lg:col-span-7 col-span-12 lg:ml-6 ml-0 md:mx-16 sm:mx-0 md:mt-20 sm:mt-10">
                <div>
                    <div class="bg-white rounded-xl lg:shadow-lg shadow-none lg:w-[650px] w-full md:border-2 md:border-light-50">
                        <div class="mx-10 sm:mx-4">
                            <div class="flex items-center justify-between">
                                <button class="btn-umum font-semibold text-base text-light-70 pb-3 pt-6 border-b-4 border-primary-50 px-5 sm:px-2">Umum</button>
                                <button class="btn-dokumen font-semibold text-light-70 border-b-4 pb-3 pt-6 px-5 sm:px-2">Dokumen</button>
                                <button class="btn-rating font-semibold text-light-70 border-b-4 pb-3 pt-6 px-5 sm:px-2"><span class="sm:hidden block">Rating
                                        &
                                        Ulasan</span> <span class="sm:block hidden">Ulasan</span></button>
                                <button class="btn-riwayat font-semibold text-light-70 border-b-4 pb-3 pt-6 px-5 sm:px-2">Riwayat</button>
                            </div>
                        </div>
                        <div class="border-t-2 border-light-30 -mt-[2px]"></div>
                        <div class="umum">
                            <div class="mx-10 mt-10 sm:mx-6 sm:border-2 sm:border-light-50 sm:rounded-2xl">
                                <form action="" class="sm:w-full">
                                    <div class="flex sm:flex-wrap items-center justify-between sm:mt-5">
                                        <div class="sm:w-full sm:mx-4">
                                            <p class="text-dark-70 font-medium">Nama Depan <span class="text-[#FF0000]">*</span></p>
                                            <input type="text" class="border-2 border-light-50 rounded-md w-[270px] sm:w-full py-3 px-3 mt-2 focus:outline-primary-50">
                                        </div>
                                        <div class="sm:mt-5 sm:w-full sm:mx-4">
                                            <p class="text-dark-70 font-medium">Nama Belakang <span class="text-[#FF0000]">*</span></p>
                                            <input type="text" class="border-2 border-light-50 rounded-md w-[270px] sm:w-full py-3 px-3 mt-2 focus:outline-primary-50">
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-between mt-5 sm:mx-4">
                                        <div>
                                            <p class="text-dark-70 font-medium">Kota <span class="text-[#FF0000]">*</span>
                                            </p>
                                            <input type="text" class="border-2 border-light-50 rounded-md w-[270px] sm:w-[135px] py-3 px-3 mt-2 focus:outline-primary-50">
                                        </div>
                                        <div>
                                            <p class="text-dark-70 font-medium">Provinsi <span class="text-[#FF0000]">*</span></p>
                                            <input type="text" class="border-2 border-light-50 rounded-md w-[270px] sm:w-[135px] py-3 px-3 mt-2 focus:outline-primary-50">
                                        </div>
                                    </div>
                                    <div class="mt-5 sm:mx-4">
                                        <p class="text-dark-70 font-medium">Tentang Saya <span class="text-[#FF0000]">*</span></p>
                                        <textarea name="" id="" cols="" rows="4" class="border-2 border-light-50 rounded-md sm:w-full py-3 px-3 mt-2 w-full focus:outline-primary-50"></textarea>
                                        <p class="text-light-70 text-xs mt-1 font-medium"><span class="text-[#FF0000]">*</span> Masukan maksimal 100 kata</p>
                                    </div>
                                    <div class="flex sm:flex-wrap items-center justify-between mt-5">
                                        <div class="sm:w-full sm:mx-4">
                                    ...
                                    <div class="sm:mx-4">
                                        <button class="font-semibold text-base text-white bg-primary-50 rounded-lg w-full py-4 mt-12 mb-20 sm:mb-12 hover:bg-primary-70">Simpan
                                            Perubahan</button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="dokumen hidden">
                            <div>
                                <div class="mx-10 mt-10 sm:mx-6 sm:border-2 sm:border-light-50 sm:rounded-2xl">
                                    <form action="" class="sm:mx-4 sm:mt-5">
                                        <p class="text-base font-semibold text-dark-70">CV (Curriculum Vitae)</p>
                                        <input type="file" id="cv" class="hidden">
                                        <label for="cv" class="flex flex-col items-center border-2 border-dashed border-light-90 rounded-lg py-10 mt-4 cursor-pointer">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="66" height="66" viewBox="0 0 66 66" fill="none">
                                                <path d="M30.25 52.25H35.75V40.7687L40.15 45.1687L44 41.25L33 30.25L22 41.25L25.9188 45.1L30.25 40.7687V52.25ZM11 60.5V5.5H38.5L55 22V60.5H11ZM35.75 24.75H49.5L35.75 11V24.75Z" fill="#CCCCCC" />
                                            </svg>
                                            <p class="text-light-50 mt-2"><span class="sm:hidden block">Tarik & lepaskan
                                                    filemu atau <span class="text-primary-50 font-semibold underline hover:text-primary-30">Pilih
                                                        sendiri</span></span><span class="sm:block hidden">Ketuk untuk
                                                    unggah file</span>
                                            </p>
                                        </label>
                                        ...
                                        <div class="cvUpload">
                                            ...
                                            <div class="mt-3">
                                                <div class="flex items-center justify-between border-2 border-light-70 rounded-xl py-3 sm:py-2 px-4 sm:px-2 mt-2">
                                                    <div class="flex items-center gap-2 sm:gap-1">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                            <path d="M13 9V3.5L18.5 9M6 2C4.89 2 4 2.89 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2H6Z" fill="#B3B3B3" />
                                                        </svg>
                                                        <p class="text-base text-light-70 sm:text-xs">Ferrol 19
                                                            detik.mp4</p>
                                                    </div>
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <button form="none" class="btn-cv group" onclick="hideDiv('cvUpload')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                <path class="group-hover:fill-primary-50" d="M12 1.5C6.15 1.5 1.5 6.15 1.5 12C1.5 17.85 6.15 22.5 12 22.5C17.85 22.5 22.5 17.85 22.5 12C22.5 6.15 17.85 1.5 12 1.5ZM16.05 17.25L12 13.2L7.95 17.25L6.75 16.05L10.8 12L6.75 7.95L7.95 6.75L12 10.8L16.05 6.75L17.25 7.95L13.2 12L17.25 16.05L16.05 17.25Z" fill="#CCCCCC" />
                                                            </svg></button>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-3">
                                                <div class="flex items-center justify-between border-2 border-light-70 rounded-xl py-3 sm:py-2 px-4 sm:px-2 mt-2">
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="border-[1px] border-[#D9D9D9] h-8"></div>
                                                        <button form="none" class="btn-porto group" onclick="hideDiv('portoUpload')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                <path class="group-hover:fill-primary-50" d="M12 1.5C6.15 1.5 1.5 6.15 1.5 12C1.5 17.85 6.15 22.5 12 22.5C17.85 22.5 22.5 17.85 22.5 12C22.5 6.15 17.85 1.5 12 1.5ZM16.05 17.25L12 13.2L7.95 17.25L6.75 16.05L10.8 12L6.75 7.95L7.95 6.75L12 10.8L16.05 6.75L17.25 7.95L13.2 12L17.25 16.05L16.05 17.25Z" fill="#CCCCCC" />
                                                            </svg></button>
                                                    </div>
                                                </div>
                        ...
                        <div class="rating hidden">
                            <div class="mx-10 sm:mx-6 mt-8 pb-14 sm:pb-7 sm:border-2 sm:border-light-50 sm:rounded-2xl px-5 py-8">
                                <div class="border-2 border-light-70 rounded-lg py-10 sm:py-5">
                                    <div class="flex items-center justify-center sm:justify-between sm:mx-5 gap-16 sm:gap-0">
                                        <div class="text-center">
                                            <p class="text-[80px] sm:text-6xl text-dark-70 font-bold leading-[90px]">4.5
                                            </p>
                                            <div class="flex items-center gap-2 sm:gap-1">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-4" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <path d="M10.0003 13.2708L12.6253 14.875L11.9378 11.875L14.2503 9.875L11.2087 9.60417L10.0003 6.77083V13.2708ZM4.85449 18.3333L6.20866 12.4792L1.66699 8.54167L7.66699 8.02083L10.0003 2.5L12.3337 8.02083L18.3337 8.54167L13.792 12.4792L15.1462 18.3333L10.0003 15.2292L4.85449 18.3333Z" fill="#020179" />
                                                </svg>
                                            </div>
                                            <p class="text-light-70 text-base font-medium sm:text-xs">Dari
                                                <span>145</span> Review
                                            </p>
                                        </div>
                                        <div>
                                            <div class="flex items-center gap-3 sm:gap-1">
                                                <p class="flex items-center gap-1 text-base sm:text-sm font-semibold text-light-70">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                                                        <path d="M3.64062 13.75L4.65625 9.35938L1.25 6.40625L5.75 6.01562L7.5 1.875L9.25 6.01562L13.75 6.40625L10.3437 9.35938L11.3594 13.75L7.5 11.4219L3.64062 13.75Z" fill="#B3B3B3" />
                                                    </svg> 5
                                                </p>
                                                <progress class="progress bg-light-30 w-56 sm:w-28" value="90" max="100"></progress>
                                            </div>
                                            <div class="flex items-center gap-3 sm:gap-1 mt-1">
                                                <p class="flex items-center gap-1 text-base sm:text-sm font-semibold text-light-70">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                                                        <path d="M3.64062 13.75L4.65625 9.35938L1.25 6.40625L5.75 6.01562L7.5 1.875L9.25 6.01562L13.75 6.40625L10.3437 9.35938L11.3594 13.75L7.5 11.4219L3.64062 13.75Z" fill="#B3B3B3" />
                                                    </svg> 4
                                                </p>
                                                <progress class="progress bg-light-30 w-56 sm:w-28" value="70" max="100"></progress>
                                            </div>
                                            <div class="flex items-center gap-3 sm:gap-1 mt-1">
                                                <p class="flex items-center gap-1 text-base sm:text-sm font-semibold text-light-70">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                                                ...
                                                <progress class="progress bg-light-30 w-56 sm:w-28" value="50" max="100"></progress>
                                            </div>
                                            <div class="flex items-center gap-3 sm:gap-1 mt-1">
                                                <p class="flex items-center gap-1 text-base sm:text-sm font-semibold text-light-70">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                                                ...
                                                <progress class="progress bg-light-30 w-56 sm:w-28" value="30" max="100"></progress>
                                            </div>
                                            <div class="flex items-center gap-4 sm:gap-2 mt-1">
                                                <p class="flex items-center gap-1 text-base sm:text-sm font-semibold text-light-70">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                                                        <path d="M3.64062 13.75L4.65625 9.35938L1.25 6.40625L5.75 6.01562L7.5 1.875L9.25 6.01562L13.75 6.40625L10.3437 9.35938L11.3594 13.75L7.5 11.4219L3.64062 13.75Z" fill="#B3B3B3" />
                                                    </svg> 1
                                                </p>
                                                <progress class="progress bg-light-30 w-56 sm:w-28" value="10" max="100"></progress>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="leading-5 mt-4 sm:text-xs ml-16 sm:ml-0">Kain batik merupakan produk yang
                                        banyak
                                        digemari
                                        oleh masyarakat, bagus di desa maupun di kota. Bakal namun, saat
                                        kini
                                ...
                                <div class="flex items-center justify-between mt-7">
                                    ...
                                    <div class="flex gap-3">
                                        <button class="border-2 border-light-50 rounded-full p-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <path d="M6.52301 9.16645H16.6663V10.8331H6.52301L10.993 15.3031L9.81467 16.4814L3.33301 9.99978L9.81467 3.51811L10.993 4.69645L6.52301 9.16645Z" fill="#CCCCCC" />
                                            </svg></button>
                                        <button class="border-2 border-primary-50 rounded-full p-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <path d="M13.477 10.8336H3.33366V9.16689H13.477L9.00699 4.69689L10.1853 3.51855L16.667 10.0002L10.1853 16.4819L9.00699 15.3036L13.477 10.8336Z" fill="#020179" />
                                            </svg></button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="riwayat hidden">
                            <div class="mx-10 sm:mx-6 mt-10 pb-14 sm:border-2 sm:border-light-50 sm:rounded-2xl sm:px-3 sm:py-6">
                                <div>
                                    ...
                                    <div class="border-2 border-light-70 rounded-2xl p-7 sm:p-3 mt-10 sm:mt-6">
                                        <div class="flex items-center justify-between">
                                            <h4 class="text-2xl sm:text-base sm:leading-5 text-dark-70">Menerjemahkan
                                                naskah <br>
                                                kedalam bahasa
                                                inggris</h4>
                                            <div class="sm:hidden block">
                                                <div class="bg-[#E6E6E6] flex items-center gap-2 h-10 px-6 rounded-badge justify-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="7" height="7" viewBox="0 0 7 7" fill="none">
                                                        <circle opacity="0.7" cx="3.5" cy="3.5" r="3.5" fill="#5E5E5E" />
                                                    </svg>
                                                    <p class="text-dark-30 font-semibold sm:text-xs">Gagal</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex gap-10 sm:gap-0 sm:justify-between mt-7">
                                        ...
                                        <div class="sm:block hidden mt-5 mb-3">
                                            <div class="bg-[#E6E6E6] flex items-center gap-2 w-28 py-2 rounded-badge justify-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="7" height="7" viewBox="0 0 7 7" fill="none">
                                                    <circle opacity="0.7" cx="3.5" cy="3.5" r="3.5" fill="#5E5E5E" />
                                                </svg>
                                                <p class="text-dark-30 font-semibold sm:text-xs">Gagal</p>
                                ...
                                <div class="flex items-center justify-between mt-10">
                                    <p class="text-base font-medium text-light-50 sm:text-sm"><span>1</span> dari
                                        <span>20</span>
                                        halaman
                                    </p>
                                    <div class="flex gap-3">
