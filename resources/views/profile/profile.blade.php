                ...
                <div>
                    <div
                                ...
                                <form action="" class="sm:w-full">
                                    <div class="flex sm:flex-wrap items-center justify-between sm:mt-5">
                                        <div class="sm:w-full sm:mx-4">
                                            ...
                                            <input type="text"
                                                class="border-2 border-light-50 rounded-md w-[270px] sm:w-full py-3 px-3 mt-2 focus:outline-primary-50">
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between mt-5 sm:mx-4">
                                        <div>
                                            ...
                                            <input type="text"
                                                class="border-2 border-light-50 rounded-md w-[270px] sm:w-[135px] py-3 px-3 mt-2 focus:outline-primary-50">
                                        </div>
                                        <div>
                                    ...
                                    <div class="mt-5 sm:mx-4">
                                        ...
                                        <textarea name="" id="" cols="" rows="4"
                                            class="border-2 border-light-50 rounded-md sm:w-full py-3 px-3 mt-2 w-full focus:outline-primary-50"></textarea>
                                    ...
                                    <div class="sm:mx-4">
                                        <button
                                            class="font-semibold text-base text-white bg-primary-50 rounded-lg w-full py-4 mt-12 mb-20 sm:mb-12 hover:bg-primary-70">Simpan
                                            Perubahan</button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="mx-10 mt-10 sm:mx-6 sm:border-2 sm:border-light-50 sm:rounded-2xl">
                                    <form action="" class="sm:mx-4 sm:mt-5">
                                        ...
                                        <div class="cvUpload">
                                            ...
                                            <div class="mt-3">
                                                <div
                                                    class="flex items-center justify-between border-2 border-light-70 rounded-xl py-3 sm:py-2 px-4 sm:px-2 mt-2">
                        ...
                        <div class="rating hidden">
                            <div
                                class="mx-10 sm:mx-6 mt-8 pb-14 sm:pb-7 sm:border-2 sm:border-light-50 sm:rounded-2xl px-5 py-8">
                                    ...
                                    <div class="border-2 border-light-70 rounded-2xl p-7 sm:p-3">
                                        ...
                                        <div class="flex gap-11 sm:gap-5 mt-3">
                                            ...
                                            <div class="flex gap-2">
                                                ...
                                                <div>
                                                    <p class="text-xs text-light-70">Nilai <span
                                                            class="sm:hidden">Projek</span></p>
