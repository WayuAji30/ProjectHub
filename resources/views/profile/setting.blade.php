        ...
        <div class="relative z-10 w-screen max-w-md mx-auto overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center">
                <div class="relative transform overflow-hidden rounded-3xl bg-white drop-shadow-xl transition-all text-center w-[480px]">
                    <img src="{{asset('assets/img_index/asset/profile/modalsetting.png')}}" alt="ModalSetting" class="mx-auto mt-9">
                    <h1 class="font-semibold text-[28px] text-primary-50 mt-6 sm:mt-3">Verifikasi Dulu Yuk</h1>
                    <p class="text-base sm:text-sm text-light-90 mt-7 sm:mt-4">Perubahan yang kamu lakukan ngga <br class="sm:block hidden"> akan kami <br class="sm:hidden block">
                        simpan
                        sebelum
                        kamu<br class="sm:block hidden"> verifikasi. Udah dikirimin <br class="sm:hidden block"> email
                        yah di<br class="sm:block hidden"> <span class="font-medium text-primary-50">masterlimbad@gmail.com</span></p>
                    <form action="/profile" target="_blank" class="mx-10">
                        <button class="text-white text-base font-semibold bg-primary-50 rounded-md py-3 mt-10 w-full hover:bg-primary-70 transition-all duration-200 ease-in-out">Buka
                            Gmail</button>
                    </form>
                    <button class="text-primary-50 my-5 font-semibold hover:underline transition-all duration-200 ease-in-out" id="closesetting">Kembali Ke Beranda</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="mt-10 sm:mt-8">
                    <form action="">
                        ...
                        <div class="mt-8 sm:mt-5 flex md:flex-wrap sm:flex-wrap items-center justify-between">
                            ...
                            <input required type="email" name="" id="" class="py-3 sm:text-sm border-2 border-light-50 w-[833px] md:w-full md:mt-5 sm:mt-3 rounded-lg px-5 font-medium text-base text-dark-70 focus:outline-primary-50">
                        </div>
                        <div class="flex md:flex-wrap sm:flex-wrap md:gap-5 gap-3 mt-10 sm:mt-5 lg:gap-40">
                            ...
                            <div>
                                <input type="checkbox" class="toggle border-[#D9D9D9] bg-[#D9D9D9] checked:border-primary-50 checked:bg-primary-50" />
                                <p class="text-[15px] text-light-70 mt-5 sm:text-xs sm:mt-3">Dengan menyalakan
                                    ...
                                    menerima notifikasi pesan dari pengguna <br class="sm:hidden block"> lain selama<br class="sm:block hidden">
                                    mengerjakan projek. Anda
                                    juga akan menerima<br class="sm:block hidden"> update rutin dari ProjectHub <br class="sm:hidden block"> terkait
                                    informasi dan<br class="sm:block hidden"> penawaran
                                    terbaru dari kami</p>
                            </div>
                        </div>
                        <div class="flex justify-end mt-16 sm:mt-8">
                            <button class="w-52 py-3 bg-light-50 text-white text-base sm:w-full font-semibold rounded-lg hover:drop-shadow-md">Simpan
                                Perubahan</button>
                        </div>
                    </form>
                    <form action="" class="mt-12 sm:mt-16">
                        <div class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 16 21" fill="none">
                                <path d="M7.99935 15.5832C8.48558 15.5832 8.95189 15.39 9.29571 15.0462C9.63953 14.7024 9.83268 14.2361 9.83268 13.7498C9.83268 13.2636 9.63953 12.7973 9.29571 12.4535C8.95189 12.1097 8.48558 11.9165 7.99935 11.9165C7.51312 11.9165 7.0468 12.1097 6.70299 12.4535C6.35917 12.7973 6.16602 13.2636 6.16602 13.7498C6.16602 14.2361 6.35917 14.7024 6.70299 15.0462C7.0468 15.39 7.51312 15.5832 7.99935 15.5832ZM13.4993 7.33317C13.9856 7.33317 14.4519 7.52633 14.7957 7.87014C15.1395 8.21396 15.3327 8.68027 15.3327 9.1665V18.3332C15.3327 18.8194 15.1395 19.2857 14.7957 19.6295C14.4519 19.9734 13.9856 20.1665 13.4993 20.1665H2.49935C2.01312 20.1665 1.5468 19.9734 1.20299 19.6295C0.85917 19.2857 0.666016 18.8194 0.666016 18.3332V9.1665C0.666016 8.68027 0.85917 8.21396 1.20299 7.87014C1.5468 7.52633 2.01312 7.33317 2.49935 7.33317H3.41602V5.49984C3.41602 4.28426 3.8989 3.11847 4.75844 2.25893C5.61798 1.39939 6.78377 0.916504 7.99935 0.916504C8.60124 0.916504 9.19724 1.03506 9.75331 1.26539C10.3094 1.49572 10.8147 1.83333 11.2403 2.25893C11.6659 2.68453 12.0035 3.1898 12.2338 3.74587C12.4641 4.30195 12.5827 4.89795 12.5827 5.49984V7.33317H13.4993ZM7.99935 2.74984C7.27 2.74984 6.57053 3.03957 6.05481 3.55529C5.53908 4.07102 5.24935 4.77049 5.24935 5.49984V7.33317H10.7493V5.49984C10.7493 4.77049 10.4596 4.07102 9.94389 3.55529C9.42817 3.03957 8.72869 2.74984 7.99935 2.74984Z" fill="#787878" />
                            </svg>
                        ...
                        <div class="flex items-center md:flex-wrap sm:flex-wrap justify-between mt-10 sm:mt-5">
                            ...
                            <div class="relative inline-block md:w-full sm:w-full md:mt-5 sm:mt-3">
                                <input required type="password" name="password" id="password" required class="text-dark-90 py-3 px-5 border-2 border-light-50 font-medium text-base rounded-lg lg:w-[838px] w-full focus:outline-primary-50">
                                <button class="absolute right-5 top-4 btn-eye-close" form="none"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <button class="absolute right-5 top-4 btn-eye-open" form="none" hidden><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                        ...
                        <div class="flex items-start md:flex-wrap sm:flex-wrap justify-between mt-10 sm:mt-5">
                            ...
                            <div class="md:w-full sm:w-full md:mt-5 sm:mt-3">
                                <div class="relative inline-block md:w-full sm:w-full">
                                    <input required type="password" name="password" id="password" required class="text-dark-90 py-3 px-5 border-2 border-light-50 font-medium text-base rounded-lg lg:w-[837px] w-full focus:outline-primary-50">
                                    <button class="absolute right-5 top-4 btn-eye-close" form="none"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <path d="M11 8.25C10.2706 8.25 9.57114 8.53973 9.05542 9.05546C8.53969 9.57118 8.24996 10.2707 8.24996 11C8.24996 11.7293 8.53969 12.4288 9.05542 12.9445C9.57114 13.4603 10.2706 13.75 11 13.75C11.7293 13.75 12.4288 13.4603 12.9445 12.9445C13.4602 12.4288 13.75 11.7293 13.75 11C13.75 10.2707 13.4602 9.57118 12.9445 9.05546C12.4288 8.53973 11.7293 8.25 11 8.25ZM11 15.5833C9.78438 15.5833 8.61859 15.1004 7.75905 14.2409C6.89951 13.3814 6.41663 12.2156 6.41663 11C6.41663 9.78442 6.89951 8.61864 7.75905 7.75909C8.61859 6.89955 9.78438 6.41667 11 6.41667C12.2155 6.41667 13.3813 6.89955 14.2409 7.75909C15.1004 8.61864 15.5833 9.78442 15.5833 11C15.5833 12.2156 15.1004 13.3814 14.2409 14.2409C13.3813 15.1004 12.2155 15.5833 11 15.5833ZM11 4.125C6.41663 4.125 2.50246 6.97583 0.916626 11C2.50246 15.0242 6.41663 17.875 11 17.875C15.5833 17.875 19.4975 15.0242 21.0833 11C19.4975 6.97583 15.5833 4.125 11 4.125Z" fill="#CCC" />
                                        </svg></button>
                                    <button class="absolute right-5 top-4 btn-eye-open" form="none" hidden><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                        ...
                        <div class="flex justify-end mt-16 sm:mt-8">
                            <button class="w-52 py-3 bg-primary-50 text-white text-base font-semibold sm:w-full rounded-lg hover:drop-shadow-md">Simpan
                                Perubahan</button>
                        </div>
                    </form>
                    <form action="" class="mt-12 sm:mt-16 mb-28">
                        <div class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                <g opacity="0.75">
                                    <path d="M17.4173 3.66667H14.209L13.2923 2.75H8.70898L7.79232 3.66667H4.58398V5.5H17.4173M5.50065 17.4167C5.50065 17.9029 5.69381 18.3692 6.03762 18.713C6.38144 19.0568 6.84775 19.25 7.33398 19.25H14.6673C15.1535 19.25 15.6199 19.0568 15.9637 18.713C16.3075 18.3692 16.5007 17.9029 16.5007 17.4167V6.41667H5.50065V17.4167Z" fill="#787878" />
                                </g>
                            </svg>
                        ...
                        <div class="mt-10 sm:mt-5">
                            <p class="font-medium text-base text-dark-70 sm:text-sm">Apa yang akan terjadi jika anda <br class="sm:block hidden">
                                menghapus
                                akun?</p>
                            <div class="mt-4">
                                <p class="flex items-center sm:items-start sm:text-xs gap-2 text-light-90"><svg xmlns="http://www.w3.org/2000/svg" class="sm:mt-1" width="7" height="7" viewBox="0 0 7 7" fill="none">
                                        <circle cx="3.5" cy="3.5" r="3.5" fill="#787878" />
                                    </svg>Akun kamu akan dihapus permanen dan tidak <br class="sm:block hidden"> bisa
                                    dikembalikan</p>
                                <p class="flex items-center sm:items-start sm:text-xs sm:mt-3 gap-2 text-light-90"><svg xmlns="http://www.w3.org/2000/svg" class="sm:mt-1" width="7" height="7" viewBox="0 0 7 7" fill="none">
                                        <circle cx="3.5" cy="3.5" r="3.5" fill="#787878" />
                        ...
                        <div class="mt-14 sm:mt-7 flex md:flex-wrap sm:flex-wrap items-center justify-between">
                            ...
                            <select required name="Alasan" id="" class="border-2 sm:mt-3 font-medium text-base sm:text-sm md:mt-5 text-light-90 border-light-50 py-[14px] rounded-lg lg:w-[730px] w-full px-5">
                        ...
                        <div class="flex justify-end mt-16 sm:mt-8">
                            <button class="w-52 py-3 bg-light-50 text-white text-base sm:w-full font-semibold rounded-lg hover:drop-shadow-md">Hapus
                                Akun</button>
                        </div>
                    </form>
                </div>
