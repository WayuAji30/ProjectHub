...
<div class="lg:col-span-6 col-span-12">
    <div class="lg:ml-20 lg:mt-20 md:mt-20 mt-7">
        ...
        <p class="lg:text-[35px] text-3xl lg:mt-0 mt-12 font-semibold lg:text-start text-center">Halooo, Daftar Dulu
            Ya!
        </p>
        ...
        <form action="/verify_email" method="post" class="lg:mt-14 mt-10 lg:ml-0 md:ml-32 mx-6">
            ...
            <label for="password" class="font-medium text-dark-10 mt-5">Konfirmasi Password</label> <br>
            <div class="relative inline-block sm:block">
        ...
        <div class="inline-flex items-start mt-8 mb-16 -ml-3 md:mx-[120px] sm:mx-4">
            ...
            <label class="mt-2 text-light-90 select-none sm:text-sm" For="check">
                Saya telah membaca dan menyetujui <a href=""
                    class="text-primary-50 font-medium hover:text-primary-70">persyaratan <br
                        class="lg:hidden md:hidden block"> layanan</a>
