    ...
    <div class="lg:ml-20 lg:mt-20 md:mt-20 mt-7">
        <a href="/index">
            <img src="{{asset('assets/img_index/asset/loginandregister/logomobile.svg')}}" alt=""
                class="lg:hidden block md:mx-auto sm:ml-10 sm:w-[180px]">
        </a>
        ...
        <h2 class="text-light-90 mt-3 text-start md:text-center sm:ml-10">Sudah Punya Akun? Langsung <a href="/login"
        ...
        <form action="" class="lg:ml-0 ml-32 sm:mx-10">
            <button type="submit"
                class="button-submit flex justify-center tracking-wide items-center gap-3 text-white bg-dark-70 py-3 w-[500px] sm:w-full mt-7 mb-20 text-[18px] rounded-lg font-semibold hover:bg-primary-90 transition-all duration-200 ease-linear">
