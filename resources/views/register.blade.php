...
<div class="lg:col-span-6 col-span-12">
    <div class="lg:ml-20 lg:mt-20 md:mt-20 mt-7">
        ...
        <form action="/verify_email" method="post" class="lg:mt-14 mt-10 lg:ml-0 md:ml-32 mx-6">
            ...
            <input type="text" name="emailOrPhone" id="email" class="text-dark-90 py-3 px-5 border-2 border-light-50 rounded-lg w-[500px] sm:w-full mt-4 focus:outline-primary-50" required>
            <br><br>
