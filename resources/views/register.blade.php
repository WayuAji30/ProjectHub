    ...
    <div class="lg:ml-20 lg:mt-20 md:mt-20 mt-7">
        <a href="/index">
            <img src="{{asset('assets/img_index/asset/loginandregister/logomobile.svg')}}" alt=""
                class="lg:hidden block md:mx-auto sm:ml-5 sm:w-[180px]">
        </a>
        ...
        <p class="text-light-90 mt-3 text-start md:text-center sm:ml-6">Sudah Punya Akun? Langsung <a href="/login"
        ...
        <form action="/verify_email" method="post" class="lg:mt-14 mt-10 lg:ml-0 md:ml-32 mx-6">
            <<<<<<< HEAD <label for="email" class="font-medium text-dark-10">Email</label> <br>
                ...
                <<<<<<< HEAD <input type="text" name="emailOrPhone" id="email"
                    class="text-dark-90 py-3 px-5 border-2 border-light-50 rounded-lg w-[500px] sm:w-full mt-4 focus:outline-primary-50"
                    required>
                    =======
                    ...
                    >>>>>>> 41830fdfd2295b89cf66b9c7bee19241dd75d250
                    <br><br>
                    ...
                    <div class="relative inline-block sm:block">
                        ...
                        <button class="absolute right-5 top-8 btn-eye-close" form="none"><svg
                    ...
                    <label for="konfirmasiPassword" class="font-medium text-dark-10 mt-5">Konfirmasi Password</label>
                    <br>
                    <div class="relative inline-block sm:block">
                    ...
                    <<<<<<< HEAD <button type="submit" name="submit"
                        ...
                        =======
                        <<<<<<< HEAD <div class="inline-flex items-start mt-8 -ml-3 sm:mx-4">
    ...
    <button type="submit" name="submit"
        ...
        <form action="" class="lg:ml-0 ml-32 sm:mx-6">
            <<<<<<< HEAD <button type="submit"
                ...
                =======
                <<<<<<< HEAD <button type="submit"
                    class="button-submit flex justify-center items-center gap-3 text-white bg-dark-70 py-3 w-[500px] sm:w-full mt-7 mb-16 text-[18px] rounded-lg font-semibold hover:bg-primary-90 transition-all duration-200 ease-linear">
                    =======
                    <button type="submit"
                        class="button-submit flex justify-center items-center gap-3 text-white bg-dark-70 py-3 w-[500px] sm:w-full mt-7 text-[18px] rounded-lg font-semibold hover:bg-primary-90 transition-all duration-200 ease-linear">
                        >>>>>>> ef946224ebec14b9417da62ed630e39b86c56aad
        ...
        <<<<<<< HEAD=======<div class="inline-flex items-start mt-8 mb-16 -ml-3 md:mx-[120px] sm:mx-4">
            <label class="relative flex items-start p-3 rounded-full cursor-pointer" htmlFor="check">
                <input type="checkbox"
                    class="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-light-50 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-primary-50 checked:bg-primary-50 checked:before:bg-primary-50 hover:before:opacity-10"
                    id="check" />
                <span
                    class="absolute text-white transition-opacity opacity-0 pointer-events-none top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 peer-checked:opacity-100">
