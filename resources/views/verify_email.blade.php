...
<div class="lg:col-span-6 col-span-12">
    <div class="text-center lg:mt-40 md:mt-20 mt-10">
        ...
        <div class="flex justify-center sm:mx-6">
            <button type="submit"
                id = "btn-verify"
        ...
        <p class="text-light-90 mt-5 sm:text-sm">Tidak menerima email? <a href="javascript:void(0);"
                class="text-primary-50 font-medium select-none" id = "kirim-ulang" data-id_user = "{{$user->id}}" data-email = "{{$user->email}}">Kirim ulang</a>
