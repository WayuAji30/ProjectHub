...
<div class="lg:col-span-6 col-span-12">
    <div class="text-center lg:mt-40 md:mt-20 mt-10">
        ...
        <form action="" target="_blank" class="flex justify-center sm:mx-10">
            <button type="submit" id="btn-verify" data-id_user="{{$user->id}}" data-email="{{$user->email}}" class="button-submit select-none gap-3 tracking-wide flex justify-center items-center text-white bg-primary-50 py-3 w-[500px] sm:w-full mt-12 text-[18px] rounded-lg font-semibold hover:bg-primary-70 transition-all duration-200 ease-linear">
