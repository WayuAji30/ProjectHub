...
<body class="font-inter bg-white">
    <header>
        <nav>
            <div class="fixed sm:sticky top-0 z-10 w-full">
                <div class="bg-white pt-6">
                    <div class="px-14 sm:px-6">
                        <div class="flex sm:flex-wrap items-center justify-between">
                            ...
                            <div class="relative sm:order-2 sm:mt-5">
                                <form action="">
                                    ...
                                    <input type="text" placeholder="Cari Project Disini" autocomplete="off" class="border-2 border-light-70 py-3 pl-12 text-light-50 rounded-full lg:w-[307px] w-[340px] focus:outline-primary-50 z-20" id="searchInput">
                                </form>
                            ...
                            <a href="" class="text-light-70 font-medium text-base sm:hidden">Projek Saya</a>
                            <a href="" class="flex items-center gap-2 text-primary-50 font-medium text-base sm:hidden"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
                            ...
                            <div class="border-[1px] border-[#D9D9D9] h-8 sm:hidden"></div>
                            <div class="flex items-center gap-3 sm:order-1">
                                <div class="relative">
                                    <button class="p-1 group transition-all duration-200 ease-in-out" onclick="toggleNotification()" id="btnNotif"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                                    ...
                                    <div class="absolute z-10 -ml-40 mt-4 hidden" id="notif">
                                        <div class="bg-white drop-shadow-xl rounded-md w-[370px]">
                                            <div class="flex items-center justify-between mx-6 pt-6">
                                                ...
                                                <button onclick="toggleNotification()"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                ...
                                <div class="relative">
                                    <button class="p-1 group"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                    ...
                    <div class="mt-5 border-t-2 border-b-2 border-light-30 sm:hidden">
                        <div class="mx-14">
