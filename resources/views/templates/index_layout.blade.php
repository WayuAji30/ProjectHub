                ...
                <div class="bg-white pt-6">
                    <div class="px-14">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="relative">
                                    <button class="p-1 group transition-all duration-200 ease-in-out"
                                        onclick="toggleNotification()" id="btnNotif"><svg
                                    ...
                                    <div class="absolute z-10 -ml-40 mt-4 hidden" id="notif">
                                ...
                                <div class="relative">
                                    <button class="p-1 group"><svg xmlns="http://www.w3.org/2000/svg" width="26"
