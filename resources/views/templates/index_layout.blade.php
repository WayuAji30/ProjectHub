...
<head>
    ...
    @media (min-width: 1280px) and (max-width: 1439px) {
        #btn-switch-dekstop1 button {
            padding: 12px 15px;
        }

        #btn-switch-dekstop2 button {
            padding: 12px 20px;
        }
...
<body class="font-inter bg-white">
                    ...
                    <div class="lg:px-14 md:px-12 px-6">
                        <div class="flex sm:flex-wrap items-center justify-between">
                            ...
                            <div class="relative sm:w-full sm:order-2 sm:mt-5" id="searchbar">
                                ...
                                <div class="absolute mt-2 hidden z-20 md:fixed md:left-1/2 md:transform md:-translate-x-1/2 sm:stiky sm:left-1/2 sm:transform sm:-translate-x-1/2 md:mt-3"
                                    ...
                                    <div
                                        ...
                                        <!-- INI BUAT REKOMENDASI PROJEK POPULAR -->
                            ...
                            <div class="flex items-center gap-3 sm:order-1">
                                ...
                                <div class="relative sm:block hidden">
                                    <form action="">
                                        <button
                                            ...
                                            data-tip="Notifikasi"><svg xmlns="http://www.w3.org/2000/svg" width="26"
                                ...
                                <!-- Notif dekstop dan tablet -->
                                <div
                                    class="dropdown dropdown-bottom dropdown-end dropdown-notif lg:block md:block hidden">
                                    <div tabindex="0" role="button" class=""><button onclick="handleDropdownClick()"
                                            class="p-1 btn-notif relative group transition-all duration-200 ease-in-out tooltip tooltip-bottom"
                                            data-tip="Notifikasi"><svg xmlns="http://www.w3.org/2000/svg" width="26"
                                                height="26" viewBox="0 0 26 26" fill="none">
                                                <path class="group-hover:fill-primary-50"
                                                    d="M16.25 21.1248C16.25 21.9867 15.9076 22.8134 15.2981 23.4229C14.6886 24.0324 13.862 24.3748 13 24.3748C12.138 24.3748 11.3114 24.0324 10.7019 23.4229C10.0924 22.8134 9.75 21.9867 9.75 21.1248H16.25ZM21.125 19.4998H3.4125C3.15391 19.4998 2.90592 19.3971 2.72307 19.2142C2.54022 19.0314 2.4375 18.7834 2.4375 18.5248C2.4375 18.2662 2.54022 18.0182 2.72307 17.8354C2.90592 17.6525 3.15391 17.5498 3.4125 17.5498H4.875V11.3748C4.875 7.4423 7.67 4.1598 11.3831 3.4123C11.3604 3.18635 11.3854 2.95815 11.4563 2.74243C11.5272 2.5267 11.6426 2.32824 11.7949 2.15984C11.9473 1.99144 12.1332 1.85684 12.3408 1.76472C12.5484 1.6726 12.7729 1.625 13 1.625C13.2271 1.625 13.4517 1.6726 13.6592 1.76472C13.8668 1.85684 14.0527 1.99144 14.2051 2.15984C14.3574 2.32824 14.4728 2.5267 14.5437 2.74243C14.6146 2.95815 14.6396 3.18635 14.6169 3.4123C16.4533 3.78583 18.1043 4.78246 19.2902 6.23348C20.4762 7.6845 21.1244 9.50076 21.125 11.3748V17.5498H22.5875C22.8461 17.5498 23.0941 17.6525 23.2769 17.8354C23.4598 18.0182 23.5625 18.2662 23.5625 18.5248C23.5625 18.7834 23.4598 19.0314 23.2769 19.2142C23.0941 19.3971 22.8461 19.4998 22.5875 19.4998H21.125Z"
                                    ...
                                    <ul tabindex="0" id="dropdown-content"
                                        class="dropdown-content z-[1] menu shadow w-[370px] bg-white rounded-box md:mt-8 absolute right-0">
                                        <div class="">
                                            <div class="">
                                                <div class="mx-6 pt-2">
                                                ...
                                                <div class="h-[470px] overflow-y-auto" id="notifcontent">
                                                    <div class="hover:bg-gray-100 pt-4 cursor-pointer">
                                                        ...
                                                        <button
                                                            class="text-primary-50 text-xs font-medium mt-4 ml-[85px]">
                                                            Tandai telah dibaca
                                                        </button>
                                                    ...
                                                    <div class="hover:bg-gray-100 pt-4 cursor-pointer">
                                                        ...
                                                        <button
                                                            class="text-light-90 text-xs font-medium mt-4 ml-[85px]">
                                                            Tandai telah dibaca
                                                        </button>
                                                        <div class="border-t-2 border-light-30 mx-5 mt-4"></div>
                                                    </div>
                                                ...
                                                <div class="mx-5 py-3">
                                                    <button
                                                        class="w-full bg-primary-50 text-white py-3 rounded-xl">Telah
                                                        Dibaca Semua</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- Pesan dekstop dan Tablet -->
                                <div id="dropdownPesan"
                                    class="dropdown dropdown-bottom dropdown-end dropdown-notif lg:block md:block hidden">
                                    <div tabindex="0" role="button" class=""><button
                                            class="p-1 group tooltip tooltip-bottom" data-tip="Pesan"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                                                viewBox="0 0 26 26" fill="none">
                                                <g clip-path="url(#clip0_714_850)">
                                                    <path class="group-hover:fill-primary-50"
                            ...
                            <div class="hidden">
                                <div class="btn-login-regis flex items-center gap-4">
                                    <form action="/login">
                                        <button
                                            class=" border-2 rounded-full border-primary-50 text-primary-50 px-10 py-3 font-semibold hover:bg-primary-50 hover:text-white transition-all duration-200 ease-in-out">Masuk</button>
                                    </form>
                                    <form action="/register">
                                        <button
                                            class=" border-2 rounded-full border-primary-50 text-white bg-primary-50 px-10 py-3 font-semibold hover:bg-primary-70 transition-all duration-200 ease-in-out">Daftar</button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="dropdown dropdown-bottom dropdown-end lg:block hidden">
                                ...
                                <div tabindex="0"
                                    ...
                                    <div class="mx-5">
                                        <a href="/profile"
                                            class="flex text-dark-70 items-center font-medium text-base gap-2 pl-3 py-2 hover:bg-light-30 rounded-lg"><svg
    ...
    <footer class="mt-28 container mx-auto">
        ...
        <div class="sm:mx-3 sm:block hidden sm:mt-4">
            <!-- UNTUK BERTANDA CLASS COLLAPSE BUAT MOBILE -->
...
<script src="{{asset('js/modalSetting.js')}}"></script>
<script src="{{asset('js/btn-notif.js')}}"></script>
<script src="{{asset('js/password.js')}}"></script>
<script src="{{asset('js/switch-profile.js')}}"></script>
<script src="{{asset('js/btn-pesan.js')}}"></script>
