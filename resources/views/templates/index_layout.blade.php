    ...
    <header>
        <nav>
            <div class="fixed sm:sticky top-0 z-10 w-full md:drop-shadow-md">
                <div class="bg-white pt-6 md:py-3 sm:py-2">
                        ...
                        <div class="flex sm:flex-wrap items-center justify-between">
                            <div class="flex items-center gap-2">
                                        ...
                                        <div class="menu p-4 md:w-80 w-72 min-h-full bg-white text-base-content">
                                            <div class="mx-3">
                                                ...
                                                <div class="flex items-center gap-3 mt-6">
                                                    <img src="{{asset('assets/img_index/asset/index/profile.png')}}"
                                                        alt="profile"
                                                ...
                                                <form action="/register" class="mt-5">
                                                    ...
                                                    <button
                                                        class="py-3 text-white rounded-md bg-primary-50 w-full font-medium text-[15px] hover:bg-primary-70 hidden">
                                                ...
                                                <div class="mt-4"><a href=""
                                                        class="md:text-lg text-base text-dark-10 hover:text-primary-50 flex items-center gap-2"><svg
                                                            ...
                                                            viewBox="0 0 18 18" fill="none">
                                                            <path
                                                                d="M9 16.875C4.6575 16.875 1.125 13.3425 1.125 9C1.125 4.6575 4.6575 1.125 9 1.125C13.3425 1.125 16.875 4.6575 16.875 9C16.875 13.3425 13.3425 16.875 9 16.875ZM9 2.25C5.27625 2.25 2.25 5.27625 2.25 9C2.25 12.7238 5.27625 15.75 9 15.75C12.7238 15.75 15.75 12.7238 15.75 9C15.75 5.27625 12.7238 2.25 9 2.25Z"
                                                                fill="#787878" />
                                                            <path
                                                                d="M9 12.9375C8.685 12.9375 8.4375 12.69 8.4375 12.375V5.625C8.4375 5.31 8.685 5.0625 9 5.0625C9.315 5.0625 9.5625 5.31 9.5625 5.625V12.375C9.5625 12.69 9.315 12.9375 9 12.9375Z"
                                                                fill="#787878" />
                                                            <path
                                                                d="M12.375 9.5625H5.625C5.31 9.5625 5.0625 9.315 5.0625 9C5.0625 8.685 5.31 8.4375 5.625 8.4375H12.375C12.69 8.4375 12.9375 8.685 12.9375 9C12.9375 9.315 12.69 9.5625 12.375 9.5625Z"
                                                                fill="#787878" />
                                                        </svg>Buat Projek</a>
                                                </div>
                                                <div class="mt-4"><a href=""
                                                ...
                                                <div class="mt-4 md:text-lg text-base text-dark-10 hover:text-primary-50 flex items-center justify-between"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        ...
                                                        viewBox="0 0 24 24" fill="none" id="svgjelajahimobile">
                                                ...
                                                <div class="ml-8 hidden" id="jelajahiMobileContent">
                                                    <form action="">
                                                        <button
                                                            class="md:text-lg text-base text-dark-10 hover:text-primary-50 mt-3">Blog</button>
                                                    </form>
                                                    <form action="">
                                                        <button
                                                            class="md:text-lg text-base text-dark-10 hover:text-primary-50 mt-3">Leaderboard</button>
                                                    </form>
                                                    <form action="">
                                                        <button
                                                            class="md:text-lg text-base text-dark-10 hover:text-primary-50 mt-3">Tentang
                                                            Kami</button>
                                                    </form>
                                                    <form action="">
                                                        <button
                                                            class="md:text-lg text-base text-dark-10 hover:text-primary-50 mt-3">Pusat
                                                            Bantuan</button>
                                                    </form>
                                                    <form action="">
                                                        <button
                                                            class="md:text-lg text-base text-dark-10 hover:text-primary-50 mt-3">FAQ</button>
                                                    </form>
                                                </div>
                                                <div class="mt-3 md:text-lg text-base text-dark-10 hover:text-primary-50 flex items-center justify-between"
                                                    id="kategoriMobile">
                                                    <div class="flex items-center gap-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                            viewBox="0 0 20 20" fill="none">
                                                            <path
                                                                d="M14.166 8.33398C15.5467 8.33398 16.666 7.2147 16.666 5.83398C16.666 4.45327 15.5467 3.33398 14.166 3.33398C12.7853 3.33398 11.666 4.45327 11.666 5.83398C11.666 7.2147 12.7853 8.33398 14.166 8.33398Z"
                                                                stroke="#787878" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                            <path
                                                                d="M5.83301 16.668C7.21372 16.668 8.33301 15.5487 8.33301 14.168C8.33301 12.7873 7.21372 11.668 5.83301 11.668C4.4523 11.668 3.33301 12.7873 3.33301 14.168C3.33301 15.5487 4.4523 16.668 5.83301 16.668Z"
                                                                stroke="#787878" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                            <path
                                                                d="M11.6663 11.6673H16.6663V15.834C16.6663 16.055 16.5785 16.267 16.4223 16.4232C16.266 16.5795 16.054 16.6673 15.833 16.6673H12.4997C12.2787 16.6673 12.0667 16.5795 11.9104 16.4232C11.7541 16.267 11.6663 16.055 11.6663 15.834V11.6673ZM3.33301 3.33398H8.33301V7.50065C8.33301 7.72166 8.24521 7.93363 8.08893 8.08991C7.93265 8.24619 7.72069 8.33398 7.49967 8.33398H4.16634C3.94533 8.33398 3.73337 8.24619 3.57709 8.08991C3.42081 7.93363 3.33301 7.72166 3.33301 7.50065V3.33398Z"
                                                                stroke="#787878" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                        </svg>
                                                        <p>Kategori</p>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        class=" transition-all duration-300 ease-in-out"
                                                        viewBox="0 0 24 24" fill="none" id="svgkategorimobile">
                                                        <path d="M7 10L12 15L17 10" stroke="#999999" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </div>
                                                ...
                                                <div class="mt-4 md:text-lg text-base text-dark-10 hover:text-primary-50 flex items-center justify-between"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        class=" transition-all duration-300 ease-in-out"
                                                        viewBox="0 0 24 24" fill="none" id="svgLanguageIndex">
                                                        <path d="M7 10L12 15L17 10" stroke="#999999" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </div>
                                                ...
                                                <div class="mt-4"><a href=""
                                                        class="md:text-lg text-base text-dark-10 hover:text-primary-50 flex items-center gap-2"><svg
                                                            ...
                                                            viewBox="0 0 18 18" fill="none">
                                                            <path
                                                                d="M16.7102 10.8523L15.0227 9.16481C14.9172 9.05936 14.7742 9.00012 14.625 9.00012C14.4758 9.00012 14.3328 9.05936 14.2273 9.16481L9 14.3921V16.875H11.4829L16.7102 11.6477C16.8156 11.5422 16.8749 11.3992 16.8749 11.25C16.8749 11.1008 16.8156 10.9578 16.7102 10.8523ZM11.0171 15.75H10.125V14.8579L12.9375 12.0454L13.8296 12.9375L11.0171 15.75ZM14.625 12.1421L13.7329 11.25L14.625 10.3579L15.5171 11.25L14.625 12.1421ZM4.5 9H10.125V10.125H4.5V9ZM4.5 5.625H11.25V6.75H4.5V5.625Z"
                                                                fill="#787878" />
                                                            <path
                                                                d="M14.625 2.25C14.6247 1.95172 14.5061 1.66575 14.2952 1.45483C14.0843 1.24392 13.7983 1.1253 13.5 1.125H2.25C1.95173 1.1253 1.66575 1.24392 1.45484 1.45483C1.24392 1.66575 1.1253 1.95172 1.125 2.25V9.5625C1.12375 10.6843 1.42803 11.7853 2.00519 12.7473C2.58235 13.7092 3.41059 14.4958 4.401 15.0227L7.3125 16.5752V15.3L4.93088 14.0299C4.12051 13.5988 3.44282 12.9552 2.97051 12.1682C2.49821 11.3812 2.24913 10.4804 2.25 9.5625V2.25H13.5V7.3125H14.625V2.25Z"
                                                                fill="#787878" />
                                                        </svg>Kebijakan ProjectHub</a>
                                                </div>
                                                <div class="border-t-2 border-light-30 mt-5"></div>
                                                <div class="mt-5 mb-10"><a href=""
                                                        class="md:text-lg text-base text-[#FF0000] flex items-center gap-2"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            viewBox="0 0 18 18" fill="none">
                                                            <path
                                                                d="M3.375 16.875H10.125C10.4233 16.8747 10.7093 16.7561 10.9202 16.5452C11.1311 16.3343 11.2497 16.0483 11.25 15.75V14.0625H10.125V15.75H3.375V2.25H10.125V3.9375H11.25V2.25C11.2497 1.95172 11.1311 1.66575 10.9202 1.45483C10.7093 1.24392 10.4233 1.1253 10.125 1.125H3.375C3.07672 1.1253 2.79075 1.24392 2.57983 1.45483C2.36892 1.66575 2.2503 1.95172 2.25 2.25V15.75C2.2503 16.0483 2.36892 16.3343 2.57983 16.5452C2.79075 16.7561 3.07672 16.8747 3.375 16.875Z"
                                                                fill="#D30000" />
                                                            <path
                                ...
                                <a href="/index">
                                    <img src="{{asset('assets/img_index/asset/landingPage/logoProjectHubBlue.svg')}}"
                                        alt="logoProjectHub" class="md:w-44 sm:w-40">
                                </a>
                            </div>
                            <div class="relative sm:w-full sm:order-2 sm:mt-5">
                                <form action="">
                                    <button class="absolute mt-4 pl-5 group">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            ...
                                            <g clip-path="url(#clip0_714_839)">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    class="group-hover:fill-primary-50"
                                    ...
                                    <input type="text" placeholder="Cari Project Disini" autocomplete="off"
                                        class="border-2 border-light-70 py-3 pl-12 text-light-50 rounded-full w-[307px] sm:w-full focus:outline-primary-50 z-20"
                                        id="searchInput">
                                </form>
                                <div class="absolute mt-2 hidden z-20 md:fixed md:left-1/2 md:transform md:-translate-x-1/2 sm:stiky sm:left-1/2 sm:transform sm:-translate-x-1/2 md:mt-3"
                                    id="searchHelp">
                                    <div
                                        class="bg-white drop-shadow-lg w-[700px] sm:w-[340px] border-[1px] border-light-70 rounded">
                            ...
                            <div class="dropdown lg:block hidden">
                                <div tabindex="0" role="button"
                                    class="font-medium mx-2 text-light-70 flex items-center gap-2" id="jelajahi">
                                    Jelajahi
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="transition-all duration-200 ease-in-out" width="10" height="7"
                                ...
                                <ul tabindex="0"
                                    class="dropdown-content z-[2] menu p-2 shadow bg-white drop-shadow-lg rounded-box w-44 mt-3">
                                    <a href=""
                            ...
                            <a href=""
                                class="flex items-center gap-2 text-primary-50 font-medium text-base md:hidden sm:hidden"><svg
                            ...
                            <div class="flex items-center gap-3 sm:order-1">
                                ...
                                <div class="relative sm:hidden block">
                                    <button
                                        ...
                                        <svg class="absolute top-0 right-0" xmlns="http://www.w3.org/2000/svg" width="7"
                                            height="7" viewBox="0 0 7 7" fill="none">
                                            <circle cx="3.5" cy="3.5" r="3.5" fill="#FF3D00" />
                                        </svg>
                                    </button>
                                    <div class="absolute z-10 -ml-40 mt-4 hidden md:fixed md:right-10" id="notif">
                                        <div class="bg-white drop-shadow-xl rounded-md w-[370px]">
                                            <div class="flex items-center justify-between mx-6 pt-6">
                                                <p class="text-base font-semibold">Notifikasi (<span>12</span>)</p>
                                                <button onclick="toggleNotification()"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        viewBox="0 0 20 20" fill="none">
                                                        <path
                                                            d="M16.2887 14.9617C16.4649 15.1379 16.5638 15.3767 16.5638 15.6258C16.5638 15.8749 16.4649 16.1137 16.2887 16.2899C16.1126 16.466 15.8737 16.5649 15.6247 16.5649C15.3756 16.5649 15.1367 16.466 14.9606 16.2899L10.0005 11.3281L5.03874 16.2883C4.86262 16.4644 4.62374 16.5634 4.37467 16.5634C4.1256 16.5634 3.88673 16.4644 3.71061 16.2883C3.53449 16.1122 3.43555 15.8733 3.43555 15.6242C3.43555 15.3752 3.53449 15.1363 3.71061 14.9602L8.67233 10L3.71217 5.0383C3.53605 4.86218 3.43711 4.62331 3.43711 4.37423C3.43711 4.12516 3.53605 3.88629 3.71217 3.71017C3.88829 3.53405 4.12716 3.43511 4.37624 3.43511C4.62531 3.43511 4.86418 3.53405 5.0403 3.71017L10.0005 8.67189L14.9622 3.70939C15.1383 3.53327 15.3772 3.43433 15.6262 3.43433C15.8753 3.43433 16.1142 3.53327 16.2903 3.70939C16.4664 3.88551 16.5654 4.12438 16.5654 4.37345C16.5654 4.62252 16.4664 4.86139 16.2903 5.03752L11.3286 10L16.2887 14.9617Z"
                                                            fill="#2B2B2B" />
                                                    </svg></button>
                                            </div>
                                            ...
                                            <div class="h-[470px] overflow-y-auto" id="notifcontent">
                                                        ...
                                                        <div class="flex mx-5 gap-3">
                                                            <div class="relative p-1">
                                                                ...
                                                                <svg class="absolute top-0 right-0"
                                                                    ...
                                                                    height="7" viewBox="0 0 5 5" fill="none">
                                                                    <circle cx="2.5" cy="2.5" r="2.5" fill="#020179" />
                                                                </svg>
                                                            </div>
                                                            <div class="">
                                                                <p class="font-medium text-dark-70">[Sistem] Projek yang
                                                                    anda <br> buat telah kami hapus</p>
                                                                <p class="text-xs mt-2 text-dark-70">Berdasarkan
                                                                    tinjauan
                                                                    sistem kami yang menerima banyak report dari ...</p>
                                                            </div>
                                                            <p
                                                                class="font-medium text-xs text-light-90 mt-1 flex gap-1">
                                                ...
                                                <div class="hover:bg-gray-100 pt-4 cursor-pointer">
                                                    <a href="">
                                                        <div class="flex mx-5 gap-3">
                                                            <img src="{{asset('assets/img_index/asset/index/profilenotif.png')}}"
                                                                alt="" class="h-[53px] w-[53px] p-1">
                                                            <div class="">
                                                                <p class="font-medium text-dark-70">[Projek] Lamaran
                                                                    anda
                                                                    <br> telah diterima oleh Rahm...
                                                                </p>
                                                                <p class="text-xs mt-2 text-dark-70">Selamat, Lamaran
                                                                    yang
                                                                    kamu ajukan untuk projek “Butuh Jasa UI/UX...</p>
                                                            </div>
                                                            <p
                                                                class="font-medium text-xs text-light-90 mt-1 flex gap-1">
                                                                <span>5</span> <span>jam</span>
                                                    ...
                                                    <a href="">
                                                        <div class="flex mx-5 gap-3">
                                                            <img src="{{asset('assets/img_index/asset/index/profilenotif.png')}}"
                                                                alt="" class="h-[53px] w-[53px] p-1">
                                                            <div class="">
                                                                <p class="font-medium text-light-90">[Projek] Lamaran
                                                                    anda
                                                                    <br> telah diterima oleh Rahm...
                                                                </p>
                                                                <p class="text-xs mt-2 text-light-90">Selamat, Lamaran
                                                                    yang
                                                                    kamu ajukan untuk projek “Butuh Jasa UI/UX...</p>
                                                            </div>
                                                            <p
                            ...
                            <div class="dropdown dropdown-bottom dropdown-end lg:block hidden">
                                <div tabindex="0" role="button" class="border-[3px] border-primary-50 rounded-full"
                                    id="btnProfile">
                                ...
                                <div tabindex="0"
                                    ...
                                    <div class="mx-5">
                                        ...
                                        <a href=""
                                            class="flex items-center font-medium text-base gap-2 pl-3 py-2 hover:bg-light-30 rounded-lg"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                                viewBox="0 0 22 22" fill="none">
                                                <path d="M5.5 9.16666H9.16667" stroke="black" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                                    d="M20.1648 11.4583C20.1648 11.3877 20.1667 10.9697 20.1648 10.9404C20.1318 10.4811 19.7386 10.1154 19.2436 10.0851C19.2115 10.0833 19.1739 10.0833 19.0969 10.0833H16.7118C15.0755 10.0833 13.75 11.3144 13.75 12.8333C13.75 14.3522 15.0764 15.5833 16.7108 15.5833H19.0969C19.1739 15.5833 19.2115 15.5833 19.2436 15.5815C19.7386 15.5512 20.1327 15.1855 20.1648 14.7262C20.1667 14.6969 20.1667 14.2789 20.1667 14.2083"
                                                    stroke="black" stroke-width="1.5" stroke-linecap="round" />
                                                <path
                                                    d="M16.4997 13.75C17.0059 13.75 17.4163 13.3396 17.4163 12.8333C17.4163 12.3271 17.0059 11.9167 16.4997 11.9167C15.9934 11.9167 15.583 12.3271 15.583 12.8333C15.583 13.3396 15.9934 13.75 16.4997 13.75Z"
                                                    fill="black" />
                                                <path
                                                    d="M9.16634 20.1667H11.9163C15.3731 20.1667 17.1019 20.1667 18.1753 19.0923C18.9169 18.3517 19.147 17.2993 19.2176 15.5833M19.2176 10.0833C19.1461 8.36733 18.9169 7.31499 18.1753 6.57433C17.1019 5.49999 15.3731 5.49999 11.9163 5.49999H9.16634C5.70959 5.49999 3.98076 5.49999 2.90734 6.57433C1.83301 7.64774 1.83301 9.37658 1.83301 12.8333C1.83301 16.2901 1.83301 18.0189 2.90734 19.0923C3.50592 19.6918 4.30801 19.9567 5.49967 20.0732M5.49967 5.49999L8.92342 3.22941C9.40491 2.91622 9.96696 2.74951 10.5413 2.74951C11.1157 2.74951 11.6778 2.91622 12.1593 3.22941L15.583 5.49999"
                                                    stroke="black" stroke-width="1.5" stroke-linecap="round" />
                                            </svg>Saldo & Penarikan</a>
                                        <a href=""
                                            class="flex items-center font-medium text-base gap-2 pl-3 py-2 hover:bg-light-30 rounded-lg"><svg
                                                ...
                                                <path
                                                    ...
                                                    fill="black" />
                                                <path
                                                    d="M11 15.8125C10.615 15.8125 10.3125 15.51 10.3125 15.125V6.875C10.3125 6.49 10.615 6.1875 11 6.1875C11.385 6.1875 11.6875 6.49 11.6875 6.875V15.125C11.6875 15.51 11.385 15.8125 11 15.8125Z"
                                                    fill="black" />
                                                <path
                                        ...
                                        <a href=""
                                            class="flex items-center font-medium text-base gap-2 pl-3 py-2 hover:bg-light-30 rounded-lg"><svg
                                                ...
                                                viewBox="0 0 22 22" fill="none">
                                                <path
                                                    d="M4.71434 19.9914H9.42862M7.07148 19.9914V16.8485M0.785767 8.99135V15.2771C0.785767 15.6938 0.951327 16.0935 1.24603 16.3882C1.54073 16.6829 1.94043 16.8485 2.3572 16.8485H11.7858C12.2025 16.8485 12.6022 16.6829 12.8969 16.3882C13.1916 16.0935 13.3572 15.6938 13.3572 15.2771V8.99135C13.3572 8.57458 13.1916 8.17488 12.8969 7.88018C12.6022 7.58548 12.2025 7.41992 11.7858 7.41992H2.3572C1.94043 7.41992 1.54073 7.58548 1.24603 7.88018C0.951327 8.17488 0.785767 8.57458 0.785767 8.99135Z"
                                                    stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                                    d="M11.7858 4.27748V3.49177C11.7858 3.28338 11.8685 3.08354 12.0159 2.93619C12.1632 2.78884 12.3631 2.70605 12.5715 2.70605H20.4286C20.637 2.70605 20.8369 2.78884 20.9842 2.93619C21.1316 3.08354 21.2143 3.28338 21.2143 3.49177V19.2061C21.2143 19.4144 21.1316 19.6143 20.9842 19.7616C20.8369 19.909 20.637 19.9918 20.4286 19.9918H14.1429"
                                                    stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                                    d="M16.5001 9.77706H21.2143M17.8751 6.43778C17.823 6.43778 17.773 6.41708 17.7362 6.38025C17.6993 6.34341 17.6786 6.29345 17.6786 6.24135C17.6786 6.18925 17.6993 6.13929 17.7362 6.10245C17.773 6.06562 17.823 6.04492 17.8751 6.04492C17.9272 6.04492 17.9771 6.06562 18.014 6.10245C18.0508 6.13929 18.0715 6.18925 18.0715 6.24135C18.0715 6.29345 18.0508 6.34341 18.014 6.38025C17.9771 6.41708 17.9272 6.43778 17.8751 6.43778Z"
                                                    stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>Projek Saya</a>
                                    </div>
                                    <div class="border-t-[1px] border-light-30 my-5 mx-5"></div>
                                    <div class="mx-5">
                                        ...
                                        <div class="flex items-center justify-between hover:bg-light-30 rounded-lg pl-3 pr-2 py-2 cursor-pointer"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="7"
                                                viewBox="0 0 10 7" fill="none" id="svgOpenBahasa"
                                                class=" transition-all duration-300 ease-in-out">
                                                <path d="M0.833353 1.16667L5.00002 5.75L9.16669 1.16667" stroke="#000"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </div>
                                        <div class="ml-[35px] hidden" id="openBahasa">
                                            <button
                                                class="text-base font-semibold py-2 px-2 hover:bg-light-30 w-full text-start rounded-lg text-primary-50">Bahasa
                                                Indonesia</button>
                                            <button
                                                class="text-base font-semibold py-2 px-2 hover:bg-light-30 w-full text-start rounded-lg text-light-70">English</button>
                                        </div>
                                        <a href=""
                                            class="flex items-center font-medium text-base gap-2 pl-3 py-2 hover:bg-light-30 rounded-lg"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                                viewBox="0 0 22 22" fill="none">
                                                <path
                                                    d="M20.4236 13.2639L18.3611 11.2014C18.2321 11.0726 18.0573 11.0001 17.875 11.0001C17.6927 11.0001 17.5179 11.0726 17.3889 11.2014L11 17.5904V20.625H14.0346L20.4236 14.2361C20.5524 14.1071 20.6249 13.9323 20.6249 13.75C20.6249 13.5677 20.5524 13.3929 20.4236 13.2639ZM13.4654 19.25H12.375V18.1596L15.8125 14.7221L16.9029 15.8125L13.4654 19.25ZM17.875 14.8404L16.7846 13.75L17.875 12.6596L18.9654 13.75L17.875 14.8404ZM5.5 11H12.375V12.375H5.5V11ZM5.5 6.875H13.75V8.25H5.5V6.875Z"
                                                    fill="black" />
                                                <path
                                                    d="M17.875 2.75C17.8746 2.38544 17.7297 2.03591 17.4719 1.77813C17.2141 1.52035 16.8646 1.37536 16.5 1.375H2.75C2.38544 1.37536 2.03592 1.52035 1.77813 1.77813C1.52035 2.03591 1.37537 2.38544 1.375 2.75V11.6875C1.37347 13.0586 1.74537 14.4043 2.45079 15.58C3.1562 16.7557 4.1685 17.7171 5.379 18.3611L8.9375 20.2586V18.7L6.02663 17.1476C5.03618 16.6208 4.20789 15.8342 3.63063 14.8723C3.05337 13.9103 2.74894 12.8094 2.75 11.6875V2.75H16.5V8.9375H17.875V2.75Z"
                                                    fill="black" />
                                            </svg>Kebijakan ProjectHub</a>
                                    </div>
                                    <div class="border-t-[1px] border-light-30 my-5 mx-5"></div>
                                    <div class="mx-5">
                                        <a href=""
                                            class="flex items-center font-medium text-base gap-2 pl-3 py-2 hover:bg-light-30 rounded-lg text-[#D30000] mb-5"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                                viewBox="0 0 22 22" fill="none">
                                                <path
                                                    d="M4.125 20.625H12.375C12.7396 20.6246 13.0891 20.4797 13.3469 20.2219C13.6047 19.9641 13.7496 19.6146 13.75 19.25V17.1875H12.375V19.25H4.125V2.75H12.375V4.8125H13.75V2.75C13.7496 2.38544 13.6047 2.03591 13.3469 1.77813C13.0891 1.52035 12.7396 1.37536 12.375 1.375H4.125C3.76044 1.37536 3.41091 1.52035 3.15313 1.77813C2.89535 2.03591 2.75036 2.38544 2.75 2.75V19.25C2.75036 19.6146 2.89535 19.9641 3.15313 20.2219C3.41091 20.4797 3.76044 20.6246 4.125 20.625Z"
                                                    fill="#D30000" />
                                                <path
                                                    d="M14.1529 14.1529L16.6183 11.6875H6.875V10.3125H16.6183L14.1529 7.84712L15.125 6.875L19.25 11L15.125 15.125L14.1529 14.1529Z"
                                                    fill="#D30000" />
                                            </svg>Keluar</a>
                                    </div>
                                </div>
                            ...
                            <section class="splide" aria-label="Basic Structure Example">
                                <div class="splide__track">
                                    <ul class="splide__list">
                                        <li
                                            class="splide__slide hover:bg-primary-50 hover:text-white transition-all duration-100 easy-in-out cursor-pointer py-3 w-[200px]">
                                            <a href="" class="font-medium">
                                                <p class="text-center">Web & Pemrograman</p>
                                            </a>
                                        </li>
                                        <li
                                            class="splide__slide hover:bg-primary-50 hover:text-white transition-all duration-100 easy-in-out cursor-pointer py-3 w-[170px]">
                                            <a href="" class="font-medium">
                                                <p class="text-center">Grafis dan Desain</p>
                                            </a>
                                        </li>
                                        <li
                                            class="splide__slide hover:bg-primary-50 hover:text-white transition-all duration-100 easy-in-out cursor-pointer py-3 w-[220px]">
                                            <a href="" class="font-medium">
                                        ...
                                        <li
                                            class="splide__slide hover:bg-primary-50 hover:text-white transition-all duration-100 easy-in-out cursor-pointer py-3 w-[150px]">
                                            <a href="" class="font-medium">
