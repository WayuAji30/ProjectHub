            ...
            <div class="fixed top-0 z-10 w-full">
                <div class="bg-white py-6 px-14 drop-shadow-md">
                    <div class="flex items-center justify-between">
                        ...
                        <form action="">
                            <button class="font-semibold text-base bg-primary-50 rounded-lg py-3 text-white px-7">Beralih Ke
                                Freelancer</button>
                        </form>
                        <div class="dropdown dropdown-bottom dropdown-end">
                            ...
                            <div tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-white drop-shadow-lg rounded-box w-72">
