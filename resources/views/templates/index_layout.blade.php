    ...
    <header>
        <nav>
            <div class="fixed top-0 z-10 w-full">
                <div class="bg-white py-6 px-14 drop-shadow-md">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="dropdown">
                            <div tabindex="0" role="button"
                                ...
                                Jelajahi
                                <svg xmlns="http://www.w3.org/2000/svg" class="transition-all duration-200 ease-in-out"
                        ...
                        <div class="flex items-center gap-3">
                            <div class="relative">
                                <button class="p-1"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                    ...
                    <div class="mt-5">
                        <section class="splide" aria-label="Basic Structure Example">
                            <div class="splide__track">
                                <ul class="splide__list whitespace-nowrap">
                                    <li class="splide__slide hover:bg-light-30 inline-block">
