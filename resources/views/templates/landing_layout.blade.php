                ...
                <div class="md:bg-white sm:bg-white lg:bg-opacity-0 scrolled">
                    <div class="lg:mx-16 md:mx-12 mx-4 flex justify-between items-center lg:py-5 py-6">
                        <div class="flex items-center gap-3">
                                    ...
                                    <ul class="menu p-4 md:w-80 w-72 min-h-full bg-white text-base-content">
                                        <div class="md:mx-3 mx-1">
                                            <a href="/"><img
                                                    ...
                                                    alt="logoProjectHub" class="mt-5 ml-2 sm:w-44"></a>
                                            <li><a href="/register"
                                                    class="font-medium mt-8 md:text-lg text-primary-50">Daftar</a>
                                            </li>
                            ...
                            <a href="/"><img src="{{asset('assets/img_index/asset/loginandregister/logo.svg')}}"
                                    alt="logoProjectHub" class="lg:block hidden">
                                <img src="{{asset('assets/img_index/asset/landingPage/logoProjectHubBlue.svg')}}"
                                    alt="logoProjectHub" class="lg:hidden block sm:w-40">
                            </a>
                        </div>
                        <div class="flex items-center gap-5 sm:gap-0">
                            <div class="dropdown dropdown-hover lg:block hidden">
                                ...
                                <ul tabindex="0"
                                    class="dropdown-content z-[1] menu p-2 shadow bg-white drop-shadow-lg rounded-md w-40">
                            ...
                            <form action="/register">
                                <button
                                    class=" border-2 border-primary-50 bg-primary-50 rounded-full px-8 sm:px-6 py-2 font-semibold sm:font-normal lg:hidden block">Daftar</button>
                            </form>
                            <form action="/login">
                                <button
                                    class=" border-2 rounded-full px-8 lg:py-3 md:py-2 font-semibold md:border-primary-50 md:text-primary-50 sm:hidden"
                                    id="btnLogin">Masuk</button>
                            </form>
                            <div class="lg:block hidden">
                                <div class="flex items-center border-2 px-5 py-[11px] rounded-full gap-3" id="bahasa">
                                    <button id="btnID"
                                        class="font-semibold flex items-center justify-center focus:outline-none active:opacity-100 outline-none opacity-30 transition-all duration-300 ease-in-out"
                                        onclick="switchLanguage('ID')">
                                        <img src="{{asset('assets/img_index/asset/landingPage/flagIND.svg')}}"
                                            alt="Flag Indonesia" class="mr-2 select-none">
                                        ID
                                    </button>
                                    <div class="border-[1px] h-6 line-language" id="bahasa"></div>
                                    <button id="btnENG"
                                        class="font-semibold focus:outline-none active:opacity-100 outline-none opacity-30 transition-all duration-300 ease-in-out"
            ...
            <div class="grid grid-cols-12 mt-16 sm:mt-12 mb-10">
                ...
                <div class="col-span-2 lg:block hidden">
                    ...
                    <div class="mt-5">
                        ...
                        <a href="">
                            <p
                                class="text-light-90 hover:underline hover:decoration-primary-50 hover:text-primary-50 mt-2">
                                Blog
                            </p>
                        </a>
                        <a href="">
