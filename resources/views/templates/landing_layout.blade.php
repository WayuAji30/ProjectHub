                ...
                <div class="md:bg-white sm:bg-white lg:bg-opacity-0 scrolled">
                    <div class="lg:mx-16 md:mx-12 mx-4 flex justify-between items-center lg:py-7 py-6">
                        ...
                        <div class="flex items-center gap-5 sm:gap-0">
                            ...
                            <a href="" class="font-medium lg:block hidden">Daftar</a>
                            <form action="">
                                <button
                            ...
                            <form action="">
                                <button
                                    class=" border-2 border-white rounded-full px-8 lg:py-3 md:py-2 font-semibold md:border-primary-50 md:text-primary-50 sm:hidden">Masuk</button>
                            </form>
                            <div class="lg:block hidden">
                                <div class="flex items-center border-2 border-white px-5 py-3 rounded-full gap-3">
                                    <button id="btnID"
                                        class="font-semibold flex items-center justify-center focus:outline-none active:opacity-100 opacity-30"
                                        onclick="switchLanguage('ID')">
                                        <img src="{{asset('assets/img_index/asset/landingPage/flagIND.svg')}}"
                                            alt="Flag Indonesia" class="mr-2">
                                        ID
                                    </button>
                                    <div class="border-[1px] h-6 line-language"></div>
                                    <button id="btnENG"
                                        class="font-semibold focus:outline-none active:opacity-100 opacity-30"
