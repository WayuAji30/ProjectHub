        ...
        <nav>
            <div class="w-full">
                <div class="md:bg-white sm:bg-white lg:bg-opacity-0 scrolled">
                    <div class="lg:mx-16 md:mx-14 mx-4 flex justify-between items-center lg:py-5 py-6">
                        ...
                        <div class="flex items-center gap-6 sm:gap-0">
                            <div class="dropdown dropdown-hover lg:block hidden" id="jelajahi">
                                <div tabindex="0" role="button" class="font-medium flex items-center gap-2">Jelajahi
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 10 7" fill="none" id="navlistWhite">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="7" hidden viewBox="0 0 10 7" fill="none" id="navlistBlue">
                                ...
                                <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-white drop-shadow-lg rounded-md w-40">
                                    <li><a href="" class="font-semibold text-primary-50">Blog</a></li>
                                    <li><a href="" class="font-semibold text-primary-50">Leaderboard</a></li>
                                    <li><a href="" class="font-semibold text-primary-50">Tentang Kami</a></li>
                                    <li><a href="" class="font-semibold text-primary-50">Bantuan</a></li>
                                    <li><a href="" class="font-semibold text-primary-50">FAQ</a></li>
                                </ul>
                            </div>
                            <a href="/register" class="font-medium lg:block hidden">Daftar</a>
                            <form action="/register" class="lg:hidden block">
                                <button class=" border-2 border-primary-50 bg-primary-50 rounded-full px-8 sm:px-6 py-2 font-semibold sm:font-normal">Daftar</button>
                            </form>
                            <form action="/login">
