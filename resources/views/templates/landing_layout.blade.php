                ...
                <div class="md:bg-white sm:bg-white lg:bg-opacity-0 scrolled">
                    <div class="lg:mx-16 md:mx-14 mx-4 flex justify-between items-center py-6">
                        <div class="flex items-center gap-3">
                                    ...
                                    <div class="menu p-4 md:w-80 w-72 min-h-full bg-white text-base-content">
                                        <div class="mx-3">
                                            ...
                                            <form action="/register" class="mt-10">
                                                <button class="py-3 text-white rounded-md bg-primary-50 w-full font-medium text-[15px] hover:bg-primary-70">Daftar
                                                    ProjectHub</button>
                                            </form>
                                            <div class="mt-5"><a href="/login" class="md:text-lg text-base text-light-90 hover:text-primary-50">Masuk</a>
                                            </div>
                                            <div class="mt-3"><a href="" class="md:text-lg text-base text-light-90 hover:text-primary-50">Blog</a>
                                            </div>
                                            <div class="mt-3"><a href="" class="md:text-lg text-base text-light-90 hover:text-primary-50">Leaderboard</a>
                                            </div>
                                            <p class="font-semibold mt-9">Umum</p>
                                            <div class="border-t-2 border-light-30 mt-2"></div>
                                            <div class="mt-3 md:text-lg text-base text-light-90 hover:text-primary-50 flex items-center justify-between" id="pLanguage">
                                                <p>Bahasa</p>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class=" transition-all duration-300 ease-in-out" viewBox="0 0 24 24" fill="none" id="svgLanguage">
                                            ...
                                            <div class="mt-3"><a href="" class="md:text-lg text-base text-light-90 hover:text-primary-50">Tentang
                                                    Kami</a>
                                            </div>
                                            <div class="mt-3"><a href="" class="md:text-lg text-base text-light-90 hover:text-primary-50">Pusat
                                                    Bantuan</a></div>
                                            <div class="mt-3"><a href="" class="md:text-lg text-base text-light-90 hover:text-primary-50">FAQ</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="/">
                                <img src="{{asset('assets/img_index/asset/loginandregister/logo.svg')}}" alt="logoProjectHub" class="lg:block hidden" id="logoWhite">
                                <img src="{{asset('assets/img_index/asset/landingPage/logoProjectHubBlue.svg')}}" alt="logoProjectHub" class="lg:hidden block sm:w-40" id="logoBlue">
                            </a>
                        </div>
                        <div class="flex items-center gap-6 sm:gap-0">
                            <div class="group relative cursor-pointer lg:block hidden" id="jelajahi">
                                <div class="flex items-center">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 10 7" class="group-hover:rotate-180 transition-all duration-200 ease-in-out" fill="none" id="navlistWhite">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="7" hidden class="group-hover:rotate-180 transition-all duration-200 ease-in-out" viewBox="0 0 10 7" fill="none" id="navlistBlue">
                                        <path d="M0.833353 1.16667L5.00002 5.75L9.16669 1.16667" stroke="#020179" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div class="invisible absolute z-50 flex w-40 flex-col bg-white px-1 py-1 drop-shadow-lg rounded-lg group-hover:visible transition-all duration-100 ease-in-out" onClick="">
                            ...
                            <form action="/register" class="lg:hidden block">
                                <button class=" border-2 border-primary-50 bg-primary-50 rounded-full px-8 sm:px-6 py-2 font-semibold sm:font-normal hover:bg-primary-70">Daftar</button>
                            </form>
                            <form action="/login">
                                <button class=" border-2 rounded-full px-8 lg:py-3 md:py-2 font-semibold md:border-primary-50 md:text-primary-50 sm:hidden hover:bg-white hover:text-primary-50 transition-all duration-200 ease-in-out" id="btnLogin">Masuk</button>
                            </form>
                            <div class="lg:block hidden">
                                <div class="flex items-center border-2 px-5 py-[11px] rounded-full gap-3" id="bahasa">
                                    <button id="btnID" class="font-semibold flex items-center justify-center focus:outline-none outline-none transition-all duration-300 ease-in-out" onclick="switchLanguage('ID')">
                                        <img src="{{asset('assets/img_index/asset/landingPage/flagIND1.svg')}}" alt="Flag Indonesia" class="mr-2 select-none border-2 rounded-full" id="flagID">
                                        ID
                                    </button>
                                    <div class="border-[1px] h-6 line-language" id=""></div>
                                    <button id="btnENG" class="font-semibold focus:outline-none outline-none opacity-30 transition-all duration-300 ease-in-out" onclick="switchLanguage('ENG')">ENG</button>
                                </div>
                            </div>
                        </div>
                    </div>
