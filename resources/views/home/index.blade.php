    ...
    <div class="container mx-auto lg:px-24 md:px-12 px-6 lg:mt-14 mt-10">
        <div class="grid grid-cols-12">
            <div class="col-span-6 sm:col-span-12 lg:mt-14">
                <form action="/detail_project" method="post">
                    @csrf
                    <input type="hidden" name="id_project" value = "{{$p->id_projects}}">
                    <h1 class="lg:text-[28px] md:text-2xl text-xl text-primary-50">
                        <button class = "text-left">{{$p->title}}</button>
                    </h1>
                </form>
                <h2 class="lg:text-base md:text-[15px] text-[14px] text-dark-70 mt-7">{{$p->description}}</h2>
                <a href="/profiles">
                    <div class="flex items-center gap-3 lg:mt-12 mt-8">
                        ...
                        <div>
                            ...
                            <p class="text-light-90">{{($user->city) ? $user->city : 'Kota'}}, {{($user->province) ? $user->province : 'Provinsi'}}</p>
                        </div>
                    </div>
                </a>
