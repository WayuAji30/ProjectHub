...
<section>
    <div class="container mx-auto lg:mt-24 mt-12 lg:px-24 px-6">
        <div class="flex lg:items-center items-start justify-between">
            <div>
                <h1 class="font-semibold lg:text-[32px] text-xl text-dark-70">Jelajahi <span
                        class="sm:hidden">Semua</span> Projek
                    <span class="sm:hidden">Yang Tersedia</span>
                </h1>
                <p class="lg:text-base text-light-70 lg:mt-3">Cari projek yang cocok dan <br class="lg:hidden"> sesuai
                    untuk
                    kamu</p>
            </div>
        ...
        <div>
            <div class="flex sm:flex-col sm:gap-3 items-center justify-between lg:mt-12 mt-8">
                <a href="" class="sm:w-full hover:shadow-xl transition-all duration-200 ease-in-out">
                    <div
                        class="flex items-center lg:gap-3 gap-6 border-2 rounded-lg bg-white border-light-90 lg:px-9 px-5 sm:w-full py-4">
                        <div>
                            <img src="{{asset('assets/img_index/asset/index/panduan.svg')}}" alt="">
                        </div>
                        <div>
                            <h2 class="font-semibold text-lg text-dark-70">Panduan Pengunaan</h2>
                            <p class="text-light-90 sm:text-xs">Pelajarin cara pakai ProjectHub disini</p>
                        </div>
                    </div>
                </a>
                <a href="" class="sm:w-full hover:shadow-xl transition-all duration-200 ease-in-out">
                    <div
                        class="flex items-center gap-3 border-2 rounded-lg bg-white border-light-90 lg:pl-8 pl-5 lg:pr-14 sm:w-full py-4">
                        <div>
                            <img src="{{asset('assets/img_index/asset/index/kebijakan.svg')}}" alt="">
                        </div>
                        <div>
                            <h2 class="font-semibold text-lg text-dark-70">Kebijakan ProjectHub</h2>
                            <p class="text-light-90 sm:text-xs">Cari tau aturan pakai ProjectHub</p>
                        </div>
                    </div>
                </a>
                <a href="" class="sm:w-full hover:shadow-xl transition-all duration-200 ease-in-out">
                    <div
                        class="flex items-center lg:gap-3 gap-4 border-2 rounded-lg bg-white border-light-90 lg:pr-24 lg:pl-8 px-5 sm:w-full py-4">
                        <div>
                            <img src="{{asset('assets/img_index/asset/index/bantuan.svg')}}" alt="">
                        </div>
                        <div>
                            <h2 class="font-semibold text-lg text-dark-70">Pusat Bantuan</h2>
                            <p class="text-light-90 sm:text-xs">Tempat kamu mengadu</p>
                        </div>
                    </div>
                </a>
            </div>
...
<section>
    <div class="container mx-auto lg:px-24 px-6 lg:mt-14 mt-10">
        <div class="grid grid-cols-12">
            <div class="lg:col-span-6 col-span-12 lg:mt-14">
                <h1 class="lg:text-[28px] text-xl text-primary-50">Butuh Jasa UI/UX Desainer Untuk Website Sekolah</h1>
                <h2 class="lg:text-base text-dark-70 mt-7">Saya memililki sebuah website jual beli pulsa, dan saya ingin
                    membuat
                ...
                <div class="flex items-center gap-6 lg:mt-14 mt-7">
                    <button class="flex items-center gap-2 text-[#FF0000] text-base font-medium"><svg
            ...
            <div class="lg:col-span-6 col-span-12 flex justify-end sm:mt-8">
                <div class="bg-[#f3f3f3] bg-opacity-70 rounded-3xl lg:w-[550px] w-full lg:px-11 px-5">
                    <div class="flex items-center justify-between mt-9">
                        <div>
                            <p class="font-medium text-base text-dark-50">Kategori :</p>
                            <div
                                class="bg-primary-50 bg-opacity-10 lg:rounded-xl rounded-md py-3 pl-3 lg:w-56 w-36 mt-5">
                                <p class="flex items-center font-semibold gap-2 text-primary-50 sm:text-xs"><svg
                                        class="sm:hidden" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    ...
                                    </svg>Grafis dan Desain</p>
                            </div>
                        </div>
                        <div>
                            <p class="font-medium text-base text-dark-50">Status Projek :</p>
                            <div
                                class="bg-[#00A410] bg-opacity-10 lg:rounded-xl rounded-md py-3 lg:pl-7 sm:pl-4 sm:w-36 lg:pr-[100px] mt-5">
                                <p class="flex items-center font-semibold gap-2 text-[#004A03] sm:text-xs">
                            ...
                            <div
                                class="bg-[#FFC807] bg-opacity-10 lg:rounded-xl rounded-md py-3 lg:px-7 sm:pl-4 sm:w-36 mt-5 hidden">
                                <p class="flex items-center font-semibold gap-2 text-[#CD9A00] sm:text-xs">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8"
                                        fill="none">
                            ...
                            <div
                                class="bg-[#454545] bg-opacity-10 lg:rounded-xl rounded-md py-3 lg:pl-7 sm:pl-4 sm:w-36 lg:pr-[100px] mt-5 hidden">
                                <p class="flex items-center font-semibold gap-2 text-dark-30 sm:text-xs">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8"
                                        fill="none">
                    ...
                    <div class="flex items-center justify-between mt-5">
                        <div>
                            <p class="flex items-center gap-1 text-primary-50 lg:text-base text-[13px] font-medium"><svg
                        ...
                        <div>
                            <p class="flex items-center gap-1 text-primary-50 lg:text-base text-[13px] font-medium"><svg
                                ...
                                </svg>Deadline <span class="sm:hidden">Project</span></p>
                    ...
                    <div class="mt-6">
                        <div class="flex items-center lg:gap-3">
                            <p class="flex items-center gap-2 text-light-90 font-medium sm:text-[11px]"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none">
                                    <path
                                        ...
                                        fill="#999999" />
                                </svg>Tanggal Diunggah</p>
                            <p class="text-light-90 sm:text-[11px] sm:ml-2">:</p>
                            <div class="flex items-center text-light-90 font-semibold lg:gap-2 sm:text-[11px] sm:ml-2">
                                <p>19 Desember 2023</p> |
                                <p>20.36 WIB</p>
                            </div>
                        </div>
                        <div class="flex items-center mt-1">
                            <p class="flex items-center gap-3 text-light-90 font-medium ml-[2px] sm:text-[11px]"><svg
                                    ...
                                    <path
                                        ...
                                        fill="#999999" />
                                </svg>Jumlah Pelamar</p>
                            <p class="text-light-90 lg:ml-7 ml-5 sm:text-[11px]">:</p>
                            <p class="text-light-90 font-semibold lg:ml-3 ml-2 sm:text-[11px]"><span>215</span> Orang
                            </p>
                        </div>
                        <div class="flex items-center mt-1">
                            <p class="flex items-center gap-3 text-light-90 font-medium sm:text-[11px]"><svg
                            ...
                            <p class="text-light-90 lg:ml-16 ml-11 sm:text-[11px]">:</p>
                            <p class="text-light-90 font-semibold lg:ml-3 ml-2 sm:text-[11px]">Iya</p>
                        </div>
                    </div>
                    <form action="">
                        <button
