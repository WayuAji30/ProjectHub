    ...
    <div class="lg:pt-48 md:pt-28 pt-8">
        <div class="container mx-auto">
            <div class="lg:px-24 md:px-12 px-6">
                <swiper-container class="mySwiper z-0" pagination="true" autoplay-delay="5000" centered-slides="true" loop="true" speed="2000" style="--swiper-pagination-color: #020179;">
                    <swiper-slide><img src="{{asset('assets/img_index/asset/index/carousel1.png')}}" alt="" class="mx-auto rounded-lg mb-12 w-full sm:h-36"></swiper-slide>
                    <swiper-slide><img src="{{asset('assets/img_index/asset/index/carousel1.png')}}" alt="" class="mx-auto rounded-lg mb-12 w-full sm:h-36"></swiper-slide>
                    <swiper-slide><img src="{{asset('assets/img_index/asset/index/carousel1.png')}}" alt="" class="mx-auto rounded-lg mb-12 w-full sm:h-36"></swiper-slide>
                    <swiper-slide><img src="{{asset('assets/img_index/asset/index/carousel1.png')}}" alt="" class="mx-auto rounded-lg mb-12 w-full sm:h-36"></swiper-slide>
                </swiper-container>
...
<section>
    <div class="container mx-auto lg:mt-24 mt-12 lg:px-24 md:px-12 px-6">
        <div class="flex lg:items-center items-start justify-between">
            <div>
                <h1 class="font-semibold lg:text-[32px] md:text-2xl text-xl text-dark-70">Jelajahi <span class="sm:hidden">Semua</span> Projek
                    <span class="sm:hidden">Yang Tersedia</span>
                </h1>
                <p class="lg:text-base text-light-70 lg:mt-3 md:mt-2 mt-0">Cari projek yang cocok dan <br class="sm:block hidden"> sesuai
                    untuk
                    kamu</p>
            </div>
            <a href="" class="flex items-center text-primary-50 lg:text-lg text-xs font-semibold hover:text-primary-70">
                Lihat Semua <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M10 17L15 12L10 7" stroke="#020179" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </a>
        </div>
        <div>
            <div class="flex sm:flex-col sm:gap-3 items-center justify-between lg:mt-12 mt-8">
                <a href="" class="sm:w-full hover:shadow-xl transition-all duration-200 ease-in-out">
                    <div class="flex items-center lg:gap-3 md:gap-2 gap-6 border-2 rounded-lg bg-white border-light-90 lg:px-9 md:px-3 px-5 sm:w-full py-4">
                        <div>
                ...
                <a href="" class="sm:w-full hover:shadow-xl transition-all duration-200 ease-in-out">
                    <div class="flex items-center gap-3 md:gap-2 border-2 rounded-lg bg-white border-light-90 lg:pl-8 md:px-3 pl-5 lg:pr-14 sm:w-full py-4">
                        <div>
                ...
                <a href="" class="sm:w-full hover:shadow-xl transition-all duration-200 ease-in-out">
                    <div class="flex items-center lg:gap-3 md:gap-2 gap-4 border-2 rounded-lg bg-white border-light-90 lg:pr-24 lg:pl-8 md:px-4 md:pr-6 px-5 sm:w-full md:py-6 py-4">
                        <div>
                ...
                <div class="bg-[#f3f3f3] bg-opacity-70 rounded-3xl lg:w-[550px] md:w-80 w-full lg:px-11 px-5">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex items-center mt-1">
                            ...
                            <p class="text-light-90 lg:ml-[58px] ml-11 lg:text-[14px] md:text-[10px] text-[11px]">:</p>
                            <p class="text-light-90 font-semibold lg:ml-3 ml-2 lg:text-[14px] md:text-[10px] text-[11px]">
                                Iya</p>
                        </div>
                    </div>
...
<div class="flex justify-center mt-12">
    <button class="text-primary-50 border-2 border-primary-50 py-3 hover:bg-primary-50 hover:text-white lg:w-96 w-60 rounded-lg font-semibold transition-all duration-200 ease-in-out">Lihat
        Selengkapnya</button>
</div>
