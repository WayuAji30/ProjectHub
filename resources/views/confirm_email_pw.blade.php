...
<div class="lg:col-span-6 col-span-12">
    <div class="text-center lg:mt-32 md:mt-20 mt-5">
        ...
        <form action="/send_confirm_email_pw" method="post" class="sm:mx-10 mt-12 sm:mt-5">
            ...
            <button type="submit"
                class="button-submit tracking-wide select-none sm:mb-20 text-white bg-primary-50 py-3 w-[500px] sm:w-full mt-8 text-[18px] rounded-lg font-semibold hover:bg-primary-70 transition-all duration-200 ease-linear">
                Kirim Email
            </button>
        </form>
    </div>
