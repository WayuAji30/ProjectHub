        ...
        <div class="grid grid-cols-12">
            ...
            <div class="lg:col-span-6 col-span-12 mt-10 md:text-center sm:text-center">
                ...
                <form action="/" class="sm:mx-6">
                    <button class="py-3 bg-primary-50 text-white font-semibold text-lg sm:text-[14px] w-[480px] sm:w-full rounded-lg lg:mt-16 md:mt-12 mt-8 hover:bg-primary-70 transition-all duration-200 ease-linear">Kembali
