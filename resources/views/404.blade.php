    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12">
            ...
            <div class="lg:col-span-6 col-span-12 mt-10 md:text-center sm:text-center">
                <h1 class="font-semibold text-5xl leading-[60px] sm:text-2xl sm:leading-8">Halamannya <br> <span
                        class="text-primary-50">Ngga
                        Ada</span>
                    Hehe...</h1>
                <h2 class="text-base text-light-90 mt-8">Halaman yang kamu cari tidak tersedia <br
                        class="hidden sm:block"> dikarenakan sudah <br class="block sm:hidden">
                    dihapus atau sedang dalam <br class="hidden sm:block"> masa pemeliharaan. Untuk saat <br
                        class="block sm:hidden"> ini, silahkan <br class="hidden sm:block"> kembali ke halaman
                    beranda.</h2>
                <form action="/" class="sm:mx-6">
                    <button
                        class="py-3 bg-primary-50 text-white font-semibold text-lg sm:text-sm sm:py-4 w-[480px] sm:w-full rounded-lg lg:mt-16 md:mt-12 mt-8 hover:bg-primary-70 transition-all duration-200 ease-linear">Kembali
